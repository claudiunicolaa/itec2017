...
(function (J, a) {
    ...
    J = function () {
        var a = window, z = a.document, F = a.navigator && a.navigator.userAgent || "", D = z && z.createElementNS && !!z.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect, B = /(edge|msie|trident)/i.test(F) && !window.opera, f = !D, h = /Firefox/.test(F), t = h && 4 > parseInt(F.split("Firefox/")[1], 10);
    ...
    (function (a) {
        var z = [], F = a.charts, D = a.doc, B = a.win;
        ...
        a.Fx.prototype = {
            dSetter: function () {
                var a = this.paths[0], h = this.paths[1], t = [], r = this.now, m = a.length, d;
                if (1 === r) t = this.toD; else if (m === h.length && 1 > r)for (; m--;)d = parseFloat(a[m]), t[m] = isNaN(d) ? a[m] : r * parseFloat(h[m] - d) + d; else t = h;
                this.elem.attr("d", t, null, !0)
            }, update: function () {
                var a = this.elem, h = this.prop, t = this.now, r = this.options.step;
                if (this[h + "Setter"]) this[h +
                "Setter"](); else a.attr ? a.element && a.attr(h, t, null, !0) : a.style[h] = t + this.unit;
                r && r.call(a, t, this)
            }, run: function (a, h, t) {
                var f = this, m = function (a) {
                ...
                var f = +new Date, t, r = this.options;
                t = this.elem;
                var m = r.complete, d = r.duration, g = r.curAnim, n;
                if (t.attr && !t.element) t = !1; else if (a || f >= d + this.startTime) {
                    this.now = this.end;
                    this.pos = 1;
                    this.update();
                    a = g[this.prop] = !0;
                    ...
                    a && m && m.call(t);
                    t = !1
                } else this.pos = r.easing((f - this.startTime) / d), this.now = this.start + (this.end - this.start) * this.pos, this.update(), t = !0;
                return t
            }, initPath: function (f, h, t) {
                function r(a) {
                    var b, e;
                    for (c = a.length; c--;)b = "M" === a[c] || "L" === a[c], e = /[a-zA-Z]/.test(a[c + 3]), b && e && a.splice(c + 1, 0, a[c + 1], a[c + 2], a[c + 1], a[c +
                    2])
                }
                ...
                function d(a, c) {
                    for (var q = (l - a.length) / b; 0 < q && q--;)e = a.slice().splice(a.length / u - b, b * u), e[0] = c[l - b - q * b], w && (e[b - 6] = e[b - 2], e[b - 5] = e[b - 1]), [].splice.apply(a, [a.length / u, 0].concat(e)), E && q--
                }

                h = h || "";
                var g, n = f.startX, y = f.endX, w = -1 < h.indexOf("C"), b = w ? 7 : 3, l, e, c;
                h = h.split(" ");
                t = t.slice();
                var E = f.isArea, u = E ? 2 : 1, q;
                w && (r(h), r(t));
                if (n && y) {
        ...
        a.merge = function () {
            var f, h = arguments, t, r = {}, m = function (d, g) {
                var n, f;
                "object" !== typeof d && (d = {});
                for (f in g)g.hasOwnProperty(f) && (n = g[f], a.isObject(n, !0) && "renderTo" !== f && "number" !== typeof n.nodeType ?
                    d[f] = m(d[f] || {}, n) : d[f] = g[f]);
                return d
            };
        ...
        a.attr = function (f, h, t) {
            var r, m;
            if (a.isString(h)) a.defined(t) ? f.setAttribute(h, t) : f && f.getAttribute && (m = f.getAttribute(h)); else if (a.defined(h) && a.isObject(h))for (r in h)f.setAttribute(r, h[r]);
            return m
        };
        a.splat = function (f) {
        ...
        a.pick = function () {
            var a = arguments, h, t, r = a.length;
            for (h =
        ...
        a.createElement = function (f, h, t, r, m) {
            ...
            var d = a.css;
            h && a.extend(f, h);
            m && d(f, {padding: 0, border: "none", margin: 0});
            t && d(f, t);
            r && r.appendChild(f);
            return f
        };
        ...
        a.wrap = function (a, h, t) {
            var f = a[h];
            a[h] = function () {
                var a = Array.prototype.slice.call(arguments), d = arguments, g = this;
                g.proceed = function () {
        ...
        a.dateFormat = function (f, h, t) {
            ...
            var r = a.Date, m = new r(h - a.getTZOffset(h)), d, g = m[r.hcGetHours](), n = m[r.hcGetDay](), y = m[r.hcGetDate](), w = m[r.hcGetMonth](), b = m[r.hcGetFullYear](), l = a.defaultOptions.lang, e = l.weekdays, c = l.shortWeekdays, E = a.pad, r = a.extend({
            ...
            for (d in r)for (; -1 !== f.indexOf("%" + d);)f = f.replace("%" + d, "function" === typeof r[d] ? r[d](h) : r[d]);
            return t ? f.substr(0, 1).toUpperCase() + f.substr(1) : f
        };
        a.formatSingle = function (f, h) {
            var t = /\.([0-9])/, r = a.defaultOptions.lang;
            /f$/.test(f) ? (t = (t = f.match(t)) ? t[1] : -1, null !== h && (h = a.numberFormat(h, t, r.decimalPoint, -1 < f.indexOf(",") ? r.thousandsSep : ""))) : h = a.dateFormat(f, h);
            return h
        };
        ...
        a.normalizeTickInterval = function (f, h, t, r, m) {
            ...
            t = a.pick(t, 1);
            d = f / t;
            h || (h = m ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10], !1 === r && (1 === t ? h = a.grep(h, function (a) {
                    return 0 === a % 1
                }) : .1 >= t && (h = [1 / t])));
        ...
        a.numberFormat = function (f, h, t, r) {
            f = +f || 0;
            h = +h;
            var m = a.defaultOptions.lang, d = (f.toString().split(".")[1] || "").length, g, n;
            -1 === h ? h = Math.min(d, 20) : a.isNumber(h) || (h = 2);
        ...
        a.getStyle = function (f, h) {
            return "width" === h ? Math.min(f.offsetWidth, f.scrollWidth) - a.getStyle(f, "padding-left") - a.getStyle(f, "padding-right") : "height" === h ? Math.min(f.offsetHeight, f.scrollHeight) - a.getStyle(f, "padding-top") - a.getStyle(f, "padding-bottom") : (f = B.getComputedStyle(f, void 0)) && a.pInt(f.getPropertyValue(h))
        };
        ...
        a.addEvent = function (f,
            ...
            f.addEventListener ? f.addEventListener(h, t, !1) : f.attachEvent && (f.hcEventsIE || (f.hcEventsIE = {}), f.hcEventsIE[t.toString()] = r, f.attachEvent("on" + h, r));
            m[h] || (m[h] = []);
            m[h].push(t);
            return function () {
                a.removeEvent(f, h, t)
        ...
        a.removeEvent = function (f, h, t) {
            ...
            var d, g = f.hcEvents, n;
            g && (h ? (d = g[h] || [], t ? (n = a.inArray(t, d), -1 < n && (d.splice(n, 1), g[h] = d), r(h, t)) : (m(), g[h] = [])) : (m(), f.hcEvents = {}))
        };
        a.fireEvent = function (f, h, t, r) {
            ...
            var d, g;
            t = t || {};
            if (D.createEvent && (f.dispatchEvent || f.fireEvent)) m = D.createEvent("Events"), m.initEvent(h, !0, !0), a.extend(m, t), f.dispatchEvent ? f.dispatchEvent(m) : f.fireEvent(h, m); else if (m)for (m = m[h] || [], d = m.length, t.target || a.extend(t, {
        ...
        a.animate = function (f, h, t) {
            var r, m = "", d, g, n;
            a.isObject(t) || (r = arguments, t = {duration: r[2], easing: r[3], complete: r[4]});
            a.isNumber(t.duration) || (t.duration = 400);
            t.easing = "function" === typeof t.easing ? t.easing : Math[t.easing] || Math.easeInOutSine;
            t.curAnim = a.merge(h);
            for (n in h)a.stop(f, n), g = new a.Fx(f, t, n), d = null, "d" === n ? (g.paths = g.initPath(f, f.d, h.d), g.toD = h.d, r = 0, d = 1) : f.attr ? r = f.attr(n) : (r = parseFloat(a.getStyle(f,
                            n)) || 0, "opacity" !== n && (m = "px")), d || (d = h[n]), d && d.match && d.match("px") && (d = d.replace(/px/g, "")), g.run(r, d, m)
        };
        a.seriesType = function (f, h, t, r, m) {
            var d = a.getOptions(), g = a.seriesTypes;
            d.plotOptions[f] = a.merge(d.plotOptions[h], t);
            g[f] = a.extendClass(g[h] || function () {
                }, r);
        ...
        D && !D.defaultView && (a.getStyle = function (f, h) {
            var t = {width: "clientWidth", height: "clientHeight"}[h];
    ...
    (function (a) {
        var z = a.each, F = a.isNumber, D = a.map, B = a.merge, f = a.pInt;
        a.Color = function (h) {
        ...
        a.Color.prototype = {
            parsers: [{
                ...
                var f, r, m, d;
                if ((this.input = h = this.names[h && h.toLowerCase ? h.toLowerCase() : ""] || h) && h.stops) this.stops = D(h.stops, function (g) {
                    return new a.Color(g[1])
                }); else if (h && "#" === h[0] && (f = h.length, h = parseInt(h.substr(1), 16), 7 === f ? r = [(h & 16711680) >> 16, (h & 65280) >> 8, h & 255, 1] : 4 === f && (r = [(h & 3840) >> 4 | (h & 3840) >> 8, (h & 240) >> 4 | h & 240, (h & 15) << 4 | h & 15, 1])), !r)for (m = this.parsers.length; m-- && !r;)d = this.parsers[m], (f = d.regex.exec(h)) && (r = d.parse(f));
                this.rgba = r || []
            }, get: function (a) {
                var h = this.input, f = this.rgba, m;
                this.stops ? (m = B(h), m.stops = [].concat(m.stops), z(this.stops, function (d, g) {
                        m.stops[g] = [m.stops[g][0], d.get(a)]
                    })) : m = f && F(f[0]) ? "rgb" === a || !a && 1 === f[3] ? "rgb(" + f[0] + "," + f[1] + "," + f[2] + ")" : "a" === a ? f[3] : "rgba(" + f.join(",") + ")" : h;
                return m
            }, brighten: function (a) {
                var h, r = this.rgba;
                if (this.stops) z(this.stops, function (m) {
                    m.brighten(a)
                }); else if (F(a) && 0 !== a)for (h = 0; 3 > h; h++)r[h] += f(255 * a), 0 > r[h] && (r[h] = 0), 255 < r[h] && (r[h] = 255);
                return this
    ...
    (function (a) {
        function z() {
            var m = a.defaultOptions.global, d = r.moment;
            if (m.timezone) {
        ...
        function F() {
            var m = a.defaultOptions.global, d, g = m.useUTC, n = g ? "getUTC" : "get", h = g ? "setUTC" : "set";
        ...
        var D = a.color, B = a.each, f = a.getTZOffset, h = a.merge, t = a.pick, r = a.win;
        a.defaultOptions = {
    ...
    (function (a) {
        ...
        z.prototype = {
            ...
            colorGradient: function (v, b, p) {
                var e = this.renderer, c, q, k, C, x, l, P, g, A, n, m, f = [], h;
                ...
                if (q) {
                    ...
                    P = v.stops;
                    n = p.radialReference;
                    u(k) && (v[q] = k = {x1: k[0], y1: k[1], x2: k[2], y2: k[3], gradientUnits: "userSpaceOnUse"});
                    "radialGradient" === q && n && !d(k.gradientUnits) && (C = k, k = G(k, e.getRadialAttr(n, C), {gradientUnits: "userSpaceOnUse"}));
                    for (m in k)"id" !== m && f.push(m, k[m]);
                    for (m in P)f.push(P[m]);
                    f = f.join(",");
                    x[f] ? n = x[f].attr("id") : (k.id = n = a.uniqueKey(), x[f] = l = e.createElement(q).attr(k).add(e.defs), l.radAttr = C, l.stops = [], w(P, function (v) {
                            0 === v[1].indexOf("rgba") ? (c = a.color(v[1]), g = c.get("rgb"), A = c.get("a")) : (g = v[1], A = 1);
                            v = e.createElement("stop").attr({offset: v[0], "stop-color": g, "stop-opacity": A}).add(l);
                            l.stops.push(v)
                        }));
                    h = "url(" + e.url + "#" + n + ")";
                    p.setAttribute(b, h);
            ...
            applyTextOutline: function (v) {
                var b = this.element, p, e, c, q, k;
                -1 !== v.indexOf("contrast") && (v = v.replace(/contrast/g,
                ...
                if ((c = v[0]) && "none" !== c && a.svg) {
                    ...
                    for (k = v.length; k--;)p = v[k], "highcharts-text-outline" === p.getAttribute("class") && l(v, b.removeChild(p));
                    q = b.firstChild;
                    w(v, function (a, v) {
                        0 === v && (a.setAttribute("x", b.getAttribute("x")), v = b.getAttribute("y"), a.setAttribute("y", v || 0), null === v && b.setAttribute("y",
                            0));
                        a = a.cloneNode(1);
                        f(a, {
            ...
            attr: function (a, b, p, e) {
                var v, c = this.element, q, k = this, x;
                "string" === typeof a && void 0 !== b && (v = a, a = {}, a[v] = b);
                if ("string" === typeof a) k = (this[a + "Getter"] || this._defaultGetter).call(this, a, c); else {
                    for (v in a)b = a[v], x = !1, e || C(this, v), this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)$/.test(v) && (q || (this.symbolAttr(a), q = !0), x = !0), !this.rotation ||
                    "x" !== v && "y" !== v || (this.doTransform = !0), x || (x = this[v + "Setter"] || this._defaultSetter, x.call(this, b, v, c), this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(v) && this.updateShadows(v, b, x));
            ...
            updateShadows: function (a, b, p) {
                for (var v = this.shadows, e = v.length; e--;)p.call(v[e], "height" === a ? Math.max(b - (v[e].cutHeight || 0), 0) : "d" === a ? this.d : b, a, v[e])
            },
            ...
            css: function (a) {
                var v = this.styles, p = {}, e = this.element, c, q = "", k = !v, C = ["textOutline", "textOverflow", "width"];
                a && a.color &&
                (a.fill = a.color);
                if (v)for (c in a)a[c] !== v[c] && (p[c] = a[c], k = !0);
                if (k) {
                    v && (a = b(v, p));
                    v = this.textWidth = a && a.width && "auto" !== a.width && "text" === e.nodeName.toLowerCase() && K(a.width);
                    this.styles = a;
                    v && !M && this.renderer.forExport && delete a.width;
                    if (x && !M) r(this.element, a); else {
                        v = function (a, v) {
            ...
            on: function (a, b) {
                var v = this, p = v.element;
                c && "click" === a ? (p.ontouchstart = function (a) {
                        v.touchEventFired = Date.now();
                        a.preventDefault();
                        b.call(p, a)
                    }, p.onclick = function (a) {
                        (-1 === O.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (v.touchEventFired || 0)) && b.call(p, a)
                    }) : p["on" + a] = b;
                return this
            },
            ...
            updateTransform: function () {
                var a = this.translateX || 0, b = this.translateY || 0, p = this.scaleX, e = this.scaleY, c = this.inverted, q = this.rotation, k = this.element;
                c && (a += this.width, b += this.height);
                a = ["translate(" + a + "," + b + ")"];
                c ? a.push("rotate(90) scale(-1,1)") : q && a.push("rotate(" + q + " " + (k.getAttribute("x") || 0) + " " + (k.getAttribute("y") || 0) + ")");
                (d(p) ||
            ...
            align: function (a, b, p) {
                ...
                var C, x;
                if (a) {
                    if (this.alignOptions = a, this.alignByTranslate = b, !p || H(p)) this.alignTo = v = p || "renderer", l(c, this), c.push(this), p = null
            ...
            getBBox: function (a, p) {
                var v, e = this.renderer, c, q = this.element, k = this.styles, C, x = this.textStr, l, G = e.cache, d = e.cacheKeys, A;
                p = L(p, this.rotation);
                c = p * g;
                C = k && k.fontSize;
                void 0 !== x && (A = x.toString(),
                -1 === A.indexOf("\x3c") && (A = A.replace(/[0-9]/g, "0")), A += ["", p || 0, C, k && k.width, k && k.textOverflow].join());
                A && !a && (v = G[A]);
                if (!v) {
                    ...
                    17 === Math.round(e) && (v.height = e = 14), p && (v.width = Math.abs(e * Math.sin(c)) + Math.abs(a * Math.cos(c)), v.height = Math.abs(e * Math.cos(c)) + Math.abs(a * Math.sin(c))));
                    if (A && 0 < v.height) {
            ...
            add: function (a) {
                var v =
                    this.renderer, b = this.element, p;
            ...
            destroy: function () {
                var a = this, b = a.element || {}, p = a.renderer.isSVG && "SPAN" === b.nodeName && a.parentGroup, e, c;
            ...
            shadow: function (a, b, p) {
                var v = [], e, c, q = this.element, k, C, x, l;
                if (!a) this.destroyShadows(); else if (!this.shadows) {
                    ...
                    for (e = 1; e <= C; e++)c = q.cloneNode(0), k = 2 * C + 1 - 2 * e, f(c, {
                        ...
                        fill: "none"
                    }), p && (f(c, "height", Math.max(f(c, "height") - k, 0)), c.cutHeight = k), b ? b.element.appendChild(c) : q.parentNode.insertBefore(c,
                            q), v.push(c);
                    this.shadows = v
                }
                return this
            ...
            zIndexSetter: function (a, b) {
                var v = this.renderer, p = this.parentGroup, e = (p || v).element || v.box, c, q = this.element, k;
                c = this.added;
                var C;
                ...
                if (c) {
                    ...
                    b = e.childNodes;
                    for (C = 0; C < b.length && !k; C++)p = b[C], c = p.zIndex, p !== q && (K(c) > a || !d(a) && d(c) || 0 > a && !d(c) && e !== v.box) && (e.insertBefore(q,
                        p), k = !0);
                    k || e.appendChild(q)
                }
                return k
        ...
        z.prototype["stroke-widthSetter"] = z.prototype.strokeSetter = function (a, b, p) {
            ...
            this.stroke && this["stroke-width"] ? (z.prototype.fillSetter.call(this, this.stroke,
                    "stroke", p), p.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0) : "stroke-width" === b && 0 === a && this.hasStroke && (p.removeAttribute("stroke"), this.hasStroke = !1)
        };
        F = a.SVGRenderer = function () {
            this.init.apply(this, arguments)
        };
        F.prototype = {
            Element: z, SVG_NS: N, init: function (a, b, p, e, c, C) {
                var v;
                e = this.createElement("svg").attr({version: "1.1", "class": "highcharts-root"}).css(this.getStyle(e));
                v = e.element;
                a.appendChild(v);
                -1 === a.innerHTML.indexOf("xmlns") && f(v, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = v;
                this.boxWrapper = e;
                this.alignedObjects = [];
                this.url = (q || k) && y.getElementsByTagName("base").length ? O.location.href.replace(/#.*?$/, "").replace(/<[^>]*>/g, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
                ...
                (b = function () {
                    ...
                    r(a, {left: Math.ceil(x.left) - x.left + "px", top: Math.ceil(x.top) - x.top + "px"})
                ...
                return p
                                        ...
                                        b, p, e) {
                var v = this.getSpanWidth(a, b), c = v > e, v = p, q, k = 0, C = p.length, x = function (a) {
                    b.removeChild(b.firstChild);
                    a && b.appendChild(y.createTextNode(a))
                };
                if (c) {
                    for (; k <= C;)q = Math.ceil((k + C) / 2), v = p.substring(0, q) + "\u2026", x(v), v = this.getSpanWidth(a, b), k === C ? k = C + 1 : v > e ? C = q - 1 : k = q;
                    0 === C && x("")
                }
                return c
            }, buildText: function (a) {
                var b = a.element, p = this, v = p.forExport, c = L(a.textStr, "").toString(), q = -1 !== c.indexOf("\x3c"), k = b.childNodes, C, x, l, G, g = f(b, "x"), d = a.styles, A = a.textWidth, u = d && d.lineHeight, n = d && d.textOutline, m = d &&
                    "ellipsis" === d.textOverflow, h = d && "nowrap" === d.whiteSpace, E = d && d.fontSize, H, I, t = k.length, d = A && !a.added && this.box, Q = function (a) {
                    var v;
                ...
                if (H !== a.textCache) {
                    ...
                    q || n || m || A || -1 !== c.indexOf(" ") ? (C = /<.*class="([^"]+)".*>/, x = /<.*style="([^"]+)".*>/, l = /<.*href="(http[^"]+)".*>/, d && d.appendChild(b), c = q ? c.replace(/<(b|strong)>/g,
                                '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [c], c = e(c, function (a) {
                            return "" !== a
                        }), w(c, function (c, e) {
                            var q, k = 0;
                            ...
                            w(q, function (c) {
                                if ("" !== c || 1 === q.length) {
                                    var d = {}, n = y.createElementNS(p.SVG_NS, "tspan"), u, w;
                                    C.test(c) && (u = c.match(C)[1],
                                        f(n, "class", u));
                                    x.test(c) && (w = c.match(x)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), f(n, "style", w));
                                    l.test(c) && !v && (f(n, "onclick", 'location.href\x3d"' + c.match(l)[1] + '"'), r(n, {cursor: "pointer"}));
                                    ...
                                    if (" " !== c) {
                                        ...
                                        f(n, d);
                                        b.appendChild(n);
                                        !k && I && (!M && v && r(n, {display: "block"}), f(n, "dy", Q(n)));
                                        if (A) {
                                            d = c.replace(/([^\^])-/g, "$1- ").split(" ");
                                            u = 1 < q.length || e ||
                                                1 < d.length && !h;
                                            var E = [], H, P = Q(n), L = a.rotation;
                                            for (m && (G = p.applyEllipsis(a, n, c, A)); !m && u && (d.length || E.length);)a.rotation = 0, H = p.getSpanWidth(a, n), c = H > A, void 0 === G && (G = c), c && 1 !== d.length ? (n.removeChild(n.firstChild), E.unshift(d.pop())) : (d = E, E = [], d.length && !h && (n = y.createElementNS(N, "tspan"), f(n, {
                                                    dy: P,
                                                    x: g
                                                }), w && f(n, "style", w), b.appendChild(n)), H > A && (A = H)), d.length && n.appendChild(y.createTextNode(d.join(" ").replace(/- /g, "-")));
                                            a.rotation = L
                                        }
                                        k++
                                    }
                        ...
                        d && d.removeChild(b), n && a.applyTextOutline && a.applyTextOutline(n)) : b.appendChild(y.createTextNode(c.replace(/&lt;/g, "\x3c").replace(/&gt;/g, "\x3e")))
                }
            }, getContrast: function (a) {
                a = t(a).rgba;
                return 510 < a[0] + a[1] + a[2] ? "#000000" : "#FFFFFF"
            }, button: function (a, p, c, e, q, k, C, l, d) {
                var v = this.label(a, p, c, d, null, null, null, null, "button"), g = 0;
                v.attr(G({padding: 8, r: 2}, q));
                var n, A, u, m;
                q = G({
                    fill: "#f7f7f7",
                    stroke: "#cccccc",
                ...
                A = k.style;
                delete k.style;
                C = G(q, {fill: "#e6ebf5", style: {color: "#000000", fontWeight: "bold"}}, C);
                u = C.style;
                delete C.style;
                l = G(q, {style: {color: "#cccccc"}}, l);
                m = l.style;
                delete l.style;
                ...
                v.setState = function (a) {
                    1 !== a && (v.state = g = a);
                    v.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass("highcharts-button-" + ["normal", "hover",
                            "pressed", "disabled"][a || 0]);
                    v.attr([q, k, C, l][a || 0]).css([n, A, u, m][a || 0])
                };
                v.attr(q).css(b({cursor: "default"}, n));
                ...
                A(a) ? (c = a, b = c.y, p = c.r, a = c.x) : c = {innerR: c, start: e, end: q};
                ...
                a = A(a) ? a : void 0 === a ? {} : {x: a, y: b, width: Math.max(p, 0), height: Math.max(c, 0)};
                ...
                1 < arguments.length && b(v, {x: p, y: c, width: e, height: q});
                ...
                var v = this, C, x = this.symbols[a], l = d(p) && x && this.symbols[a](Math.round(p), Math.round(c), e, q, k), g = /^url\((.*?)\)$/, G, n;
                x ? (C = this.path(l), C.attr("fill", "none"), b(C, {
                        ...
                        width: e,
                        height: q
                    }), k && b(C, k)) : g.test(a) && (G = a.match(g)[1], C = this.image(G), C.imgwidth = L(Q[G] && Q[G].width, k && k.width), C.imgheight = L(Q[G] && Q[G].height, k && k.height), n = function () {
                        C.attr({width: C.width, height: C.height})
                    }, w(["width", "height"],
                        function (a) {
                            C[a + "Setter"] = function (a, b) {
                                var p = {}, c = this["img" + b], e = "width" === b ? "translateX" : "translateY";
                                this[b] = a;
                                d(c) && (this.element && this.element.setAttribute(b, c), this.alignByTranslate || (p[e] = ((this[b] || 0) - c) / 2, this.attr(p)))
                            }
                        }), d(p) && C.attr({
                        x: p,
                        y: c
                    }), C.isImg = !0, d(C.imgwidth) && d(C.imgheight) ? n() : (C.attr({width: 0, height: 0}), m("img", {
                            onload: function () {
                                ...
                                Q[G] = {width: this.width, height: this.height};
                ...
                circle: function (a, b, p, c) {
                    return this.arc(a + p / 2, b + c / 2, p / 2, c / 2, {start: 0, end: 2 * Math.PI, open: !1})
                    ...
                    var q = e.start, k = e.r || p, v = e.r || c || p, C = e.end - .001;
                    p = e.innerR;
                    c = e.open;
                    var x = Math.cos(q), l = Math.sin(q), G = Math.cos(C), C = Math.sin(C);
                    ...
                    var q = Math.min(e && e.r || 0, p, c), k = q + 6, C = e && e.anchorX;
                    e = e && e.anchorY;
                    var v;
                    v = ["M", a + q, b, "L", a + p - q, b, "C", a + p, b, a + p, b, a + p, b + q, "L", a + p, b + c - q, "C", a + p, b + c, a + p, b + c, a + p - q, b + c, "L", a + q, b + c, "C", a, b + c, a, b + c, a, b + c - q, "L", a, b + q, "C", a, b, a, b, a + q, b];
                    C && C > p ? e > b + k && e < b + c - k ? v.splice(13, 3, "L", a + p, e - 6, a + p + 6, e, a + p, e + 6, a + p, b + c - q) : v.splice(13, 3, "L", a + p, c / 2, C, e, a + p, c / 2, a + p, b + c - q) : C && 0 > C ? e > b + k && e < b + c - k ? v.splice(33, 3, "L", a, e + 6, a - 6, e, a, e - 6, a, b + q) : v.splice(33, 3, "L", a, c / 2, C, e, a, c / 2, a, b + q) : e && e > c && C > a + k && C < a + p - k ? v.splice(23, 3, "L", C + 6, b + c, C, b + c + 6, C - 6, b + c, a + q, b + c) : e && 0 > e && C > a + k && C < a + p - k && v.splice(3,
                                    3, "L", C - 6, b, C, b - 6, C + 6, b, p - q, b);
                    return v
                }
            }, clipRect: function (b, p, c, e) {
                var q = a.uniqueKey(), k = this.createElement("clipPath").attr({id: q}).add(this.defs);
                ...
                c || (a.xSetter = function (a, b, p) {
                    var c =
                        p.getElementsByTagName("tspan"), e, q = p.getAttribute(b), k;
                ...
                var v = this, A = v.g("button" !== n && "label"), u = A.text = v.text("", 0, 0, l).attr({zIndex: 1}), m, f, h = 0, E = 3, H = 0, y, I, M, N, r, L = {}, K, t, Q = /^url\((.*?)\)$/.test(k), P = Q, R, S, O, U;
                ...
                S = function () {
                    ...
                    P && (m || (A.box = m = v.symbols[k] || Q ? v.symbol(k) :
                        v.rect(), m.addClass(("button" === n ? "" : "highcharts-label-box") + (n ? " highcharts-" + n + "-box" : "")), m.add(A), a = R(), p.x = a, p.y = (g ? -t : 0) + a), p.width = Math.round(A.width), p.height = Math.round(A.height), m.attr(b(p, L)), L = {})
                };
                O = function () {
                    var a = H + E, b;
                    b = g ? 0 : t;
                    d(y) && f && ("center" === r || "right" === r) && (a += {center: .5, right: 1}[r] * (y - f.width));
                ...
                A.onAdd = function () {
                    u.add(A);
                    A.attr({text: c || 0 === c ? c : "", x: e, y: q});
                    m && d(C) &&
                    A.attr({anchorX: C, anchorY: x})
                };
                ...
                return b(A, {
                    css: function (a) {
                        ...
                        return {width: f.width + 2 * E, height: f.height + 2 * E, x: f.x - E, y: f.y - E}
                    }, shadow: function (a) {
                        a && (S(), m && m.shadow(a));
                        return A
                    }, destroy: function () {
    ...
    (function (a) {
        var z = a.attr, F = a.createElement, D = a.css, B = a.defined, f = a.each, h = a.extend, t = a.isFirefox, r = a.isMS, m = a.isWebKit, d = a.pInt, g = a.SVGRenderer, n = a.win, y = a.wrap;
        h(a.SVGElement.prototype,
            {
                ...
                if (this.added) {
                    var a = this.renderer,
                        b = this.element, l = this.translateX || 0, e = this.translateY || 0, c = this.x || 0, g = this.y || 0, n = this.textAlign || "left", q = {
                            left: 0,
                            center: .5,
                            right: 1
                        }[n], x = this.styles;
                    D(b, {marginLeft: l, marginTop: e});
                    this.shadows && f(this.shadows, function (a) {
                        D(a, {marginLeft: l + 1, marginTop: e + 1})
                    });
                    this.inverted && f(b.childNodes, function (c) {
                        a.invertChild(c, b)
                    });
                    if ("SPAN" === b.tagName) {
                        var A = this.rotation, h = d(this.textWidth), k = x && x.whiteSpace, G = [A, n, b.innerHTML, this.textWidth, this.textAlign].join();
                        ...
                        D(b, {left: c + (this.xCorr || 0) + "px", top: g + (this.yCorr || 0) + "px"});
                        m && (x = b.offsetHeight);
                        this.cTT = G
                    }
                } else this.alignOnAdd = !0
            }, setSpanRotation: function (a, b, l) {
                var e = {}, c = r ? "-ms-transform" : m ? "-webkit-transform" : t ? "MozTransform" : n.opera ? "-o-transform" : "";
                e[c] = e.transform =
                    "rotate(" + a + "deg)";
        ...
        h(g.prototype, {
            html: function (a, b, l) {
                var e = this.createElement("span"), c = e.element, d = e.renderer, g = d.isSVG, q = function (a, b) {
                ...
                e.attr({text: a, x: Math.round(b), y: Math.round(l)}).css({
                    ...
                    if (this.parentGroup = a) {
                        if (b = a.div, !b) {
                            ...
                            f(k.reverse(), function (a) {
                                ...
                                h(a, {
                                    on: function () {
                                        e.on.apply({element: k[0].div}, arguments);
                                        return a
    ...
    (function (a) {
        var z, F, D = a.createElement, B = a.css, f = a.defined, h = a.deg2rad, t = a.discardElement, r = a.doc, m = a.each, d = a.erase, g = a.extend;
        z = a.extendClass;
        var n = a.isArray, y = a.isNumber, w = a.isObject, b = a.merge;
        F = a.noop;
        var l = a.pick, e = a.pInt, c = a.SVGElement, E = a.SVGRenderer, u = a.win;
        a.svg || (F = {
            docMode8: r && 8 === r.documentMode, init: function (a, b) {
                var c = ["\x3c", b, ' filled\x3d"f" stroked\x3d"f"'], e = ["position: ", "absolute", ";"], q = "div" === b;
                ...
                var b = this.renderer, c = this.element, e = b.box, q = a && a.inverted, e = a ? a.element || a : e;
                a && (this.parentGroup = a);
                q && b.invertChild(c, e);
                e.appendChild(c);
                this.added = !0;
            ...
            updateTransform: c.prototype.htmlUpdateTransform, setSpanRotation: function () {
                ...
                var q = e ? Math.cos(e * h) : 1, x = e ? Math.sin(e * h) : 0, d = l(this.elemHeight, this.element.offsetHeight), g;
                this.xCorr = 0 > q && -a;
                this.yCorr = 0 > x && -d;
                g = 0 > q * x;
                this.xCorr += x * b * (g ? 1 -
                ...
                k && "left" !== k && (this.xCorr -= a * c * (0 > q ? -1 : 1), e && (this.yCorr -= d * c * (0 > x ? -1 : 1)), B(this.element, {textAlign: k}))
            }, pathToVML: function (a) {
                for (var b = a.length, c = []; b--;)y(a[b]) ? c[b] = Math.round(10 * a[b]) - 5 : "Z" === a[b] ? c[b] = "x" : (c[b] = a[b], !a.isArc || "wa" !== a[b] && "at" !== a[b] || (c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1)));
                return c.join(" ") || "x"
            }, clip: function (a) {
                var b = this, c;
            ...
            shadow: function (a, b, c) {
                var q = [], k, d = this.element, g = this.renderer, x, n = d.style, p, C = d.path, u, A, m, f;
                C && "string" !== typeof C.value && (C = "x");
                A = C;
                if (a) {
                    m = l(a.width, 3);
                    f = (a.opacity || .15) / m;
                    for (k = 1; 3 >= k; k++)u = 2 * m + 1 - 2 * k, c && (A = this.cutOffPath(C.value, u + .5)), p = ['\x3cshape isShadow\x3d"true" strokeweight\x3d"', u, '" filled\x3d"false" path\x3d"', A, '" coordsize\x3d"10 10" style\x3d"', d.style.cssText, '" /\x3e'], x = D(g.prepVML(p), null, {
                        left: e(n.left) + l(a.offsetX, 1),
                        top: e(n.top) + l(a.offsetY, 1)
                    }), c && (x.cutOff = u + 1), p = ['\x3cstroke color\x3d"',
                        a.color || "#000000", '" opacity\x3d"', f * k, '"/\x3e'], D(g.prepVML(p), null, null, x), b ? b.element.appendChild(x) : d.parentNode.insertBefore(x, d), q.push(x);
                    this.shadows = q
                }
                return this
            }, updateShadows: F, setAttr: function (a, b) {
            ...
            }, opacitySetter: F, rotationSetter: function (a,
                                                           b, c) {
                c = c.style;
                this[b] = c[b] = a;
        ...
        }, F["stroke-opacitySetter"] = F["fill-opacitySetter"], a.VMLElement = F = z(c, F), F.prototype.ySetter = F.prototype.widthSetter = F.prototype.heightSetter = F.prototype.xSetter, F = {
            Element: F, isIE8: -1 < u.navigator.userAgent.indexOf("MSIE 8.0"), init: function (a,
                                                                                               b, c) {
                var e, k;
                this.alignedObjects = [];
                ...
                var k = this.createElement(), q = w(a);
                return g(k, {
                    members: [],
                    count: 0,
                    left: (q ? a.x : a) + 1,
                    ...
                    getCSS: function (a) {
                        var b = a.element, c = b.nodeName, p = a.inverted, e = this.top - ("shape" === c ? b.offsetTop : 0), k = this.left, b = k + this.width, q = e + this.height, e = {
                            clip: "rect(" + Math.round(p ?
                                k : e) + "px," + Math.round(p ? q : b) + "px," + Math.round(p ? b : q) + "px," + Math.round(p ? e : k) + "px)"
                        };
                        !p && a.docMode8 && "DIV" === c && g(e, {width: b + "px", height: q + "px"});
                        return e
                    },
                ...
                var k = this, q, d = /^rgba/, g, n, p = "none";
                b && b.linearGradient ? n = "gradient" : b && b.radialGradient && (n = "pattern");
                if (n) {
                    var C, u, x = b.linearGradient || b.radialGradient, f, h, v, A, E, y = "";
                    b = b.stops;
                    var w, H = [], r = function () {
                        g = ['\x3cfill colors\x3d"' + H.join(",") +
                        '" opacity\x3d"', v, '" o:opacity2\x3d"', h, '" type\x3d"', n, '" ', y, 'focus\x3d"100%" method\x3d"any" /\x3e'];
                    ...
                    if ("fill" === e)if ("gradient" === n) e = x.x1 || x[0] || 0, b = x.y1 || x[1] || 0, f = x.x2 || x[2] || 0, x = x.y2 || x[3] || 0, y = 'angle\x3d"' + (90 - 180 * Math.atan((x - b) / (f - e)) / Math.PI) + '"',
                        r(); else {
                        var p = x.r, t = 2 * p, B = 2 * p, z = x.cx, F = x.cy, J = c.radialReference, T, p = function () {
                            J && (T = l.getBBox(), z += (J[0] - T.x) / T.width - .5, F += (J[1] - T.y) / T.height - .5, t *= J[2] / T.width, B *= J[2] / T.height);
                            y = 'src\x3d"' + a.getOptions().global.VMLRadialGradientURL + '" size\x3d"' + t + "," + B + '" origin\x3d"0.5,0.5" position\x3d"' + z + "," + F + '" color2\x3d"' + E + '" ';
                            r()
                        };
                        l.added ? p() : l.onAdd = p;
                        p = A
                    } else p = C
                } else d.test(b) && "IMG" !== c.tagName ? (q = a.color(b), l[e + "-opacitySetter"](q.get("a"), e, c), p = q.get("rgb")) : (p = c.getElementsByTagName(e),
                ...
                1 < arguments.length && l.attr({x: b, y: c, width: e, height: k});
                return l
            }, createElement: function (a) {
                ...
                arc: function (a, b, c, e, k) {
                    var l = k.start, q = k.end, d = k.r || c || e;
                    c = k.innerR;
                    e = Math.cos(l);
                    var g = Math.sin(l), p = Math.cos(q), C = Math.sin(q);
                    if (0 === q - l)return ["x"];
    ...
    (function (a) {
        var z = a.correctFloat, F = a.defined, D = a.destroyObjectProperties, B = a.isNumber, f = a.merge, h = a.pick, t = a.deg2rad;
        ...
        a.Tick.prototype = {
            addLabel: function () {
                var a = this.axis, m = a.options, d = a.chart, g = a.categories, n = a.names, y = this.pos, w = m.labels, b = a.tickPositions, l = y === b[0], e = y === b[b.length - 1], n = g ? h(g[y], n[y], y) : y, g = this.label, b = b.info, c;
                a.isDatetimeAxis &&
                ...
                F(g) ? g && g.attr({text: m}) : (this.labelLength = (this.label = g = F(m) && w.enabled ? d.renderer.text(m, 0, 0, w.useHTML).css(f(w.style)).add(a.labelGroup) : null) && g.getBBox().width, this.rotation = 0)
            }, getLabelSize: function () {
                return this.label ? this.label.getBBox()[this.axis.horiz ? "height" : "width"] : 0
            }, handleOverflow: function (a) {
                var m =
                    this.axis, d = a.x, g = m.chart.chartWidth, n = m.chart.spacing, f = h(m.labelLeft, Math.min(m.pos, n[3])), n = h(m.labelRight, Math.max(m.pos + m.len, g - n[1])), w = this.label, b = this.rotation, l = {
                    left: 0,
                    center: .5,
                    right: 1
                }[m.labelAlign], e = w.getBBox().width, c = m.getSlotWidth(), E = c, u = 1, q, x = {};
                if (b) 0 > b && d - l * e < f ? q = Math.round(d / Math.cos(b * t) - f) : 0 < b && d + l * e > n && (q = Math.round((g - d) / Math.cos(b * t))); else if (g = d + (1 - l) * e, d - l * e < f ? E = a.x + E * (1 - l) - f : g > n && (E = n - a.x + E * l, u = -1), E = Math.min(c, E), E < c && "center" === m.labelAlign && (a.x += u * (c - E - l * (c - Math.min(e,
                            E)))), e > E || m.autoRotation && (w.styles || {}).width) q = E;
                q && (x.width = q, (m.options.labels.style || {}).textOverflow || (x.textOverflow = "ellipsis"), w.css(x))
            }, getPosition: function (a, m, d, g) {
                var n = this.axis, f = n.chart, h = g && f.oldChartHeight || f.chartHeight;
                return {
                    x: a ? n.translate(m + d, null, null, g) + n.transB : n.left + n.offset + (n.opposite ? (g && f.oldChartWidth || f.chartWidth) - n.right - n.left : 0),
                    y: a ? h - n.bottom + n.offset - (n.opposite ? n.height : 0) : h - n.translate(m + d, null, null, g) - n.transB
                }
            }, getLabelPosition: function (a, m, d, g, n, f, h,
                                           b) {
                var l = this.axis, e = l.transA, c = l.reversed, E = l.staggerLines, u = l.tickRotCorr || {
                        x: 0,
                        y: 0
                    }, q = n.y;
                F(q) || (q = 0 === l.side ? d.rotation ? -8 : -d.getBBox().height : 2 === l.side ? u.y + 8 : Math.cos(d.rotation * t) * (u.y - d.getBBox(!1, 0).height / 2));
                ...
                var g =
                    this.axis, n = g.options, f = this.gridLine, h = {}, b = this.pos, l = this.type, e = g.tickmarkOffset, c = g.chart.renderer, E = l ? l + "Grid" : "grid", u = n[E + "LineWidth"], q = n[E + "LineColor"], n = n[E + "LineDashStyle"];
                f || (h.stroke = q, h["stroke-width"] = u, n && (h.dashstyle = n), l || (h.zIndex = 1), a && (h.opacity = 0), this.gridLine = f = c.path().attr(h).addClass("highcharts-" + (l ? l + "-" : "") + "grid-line").add(g.gridGroup));
                if (!a && f && (a = g.getPlotLinePath(b + e, f.strokeWidth() * d, a, !0))) f[this.isNew ? "attr" : "animate"]({
                    d: a,
                    opacity: m
                })
            }, renderMark: function (a,
                                     f, d) {
                var g = this.axis, n = g.options, m = g.chart.renderer, w = this.type, b = w ? w + "Tick" : "tick", l = g.tickSize(b), e = this.mark, c = !e, E = a.x;
                a = a.y;
                var u = h(n[b + "Width"], !w && g.isXAxis ? 1 : 0), n = n[b + "Color"];
                l && (g.opposite && (l[0] = -l[0]), c && (this.mark = e = m.path().addClass("highcharts-" + (w ? w + "-" : "") + "tick").add(g.axisGroup), e.attr({
                    stroke: n,
                    "stroke-width": u
                })), e[c ? "attr" : "animate"]({
                ...
                var n = this.axis, m = n.horiz, w = n.options, b = this.label,
                    l = w.labels, e = l.step, c = n.tickmarkOffset, E = !0, u = a.x;
                a = a.y;
                b && B(u) && (b.xy = a = this.getLabelPosition(u, a, b, m, l, c, g, e), this.isFirst && !this.isLast && !h(w.showFirstLabel, 1) || this.isLast && !this.isFirst && !h(w.showLastLabel, 1) ? E = !1 : !m || n.isRadial || l.step || l.rotation || f || 0 === d || this.handleOverflow(a), e && g % e && (E = !1), E && B(a.y) ? (a.opacity = d, b[this.isNew ? "attr" : "animate"](a)) : b.attr("y", -9999), this.isNew = !1)
            }, render: function (a, f, d) {
                var g = this.axis, n = g.horiz, m = this.getPosition(n, this.pos, g.tickmarkOffset, f), w = m.x, b =
                    m.y, g = n && w === g.pos + g.len || !n && b === g.pos ? -1 : 1;
                d = h(d, 1);
                this.isActive = !0;
    ...
    (function (a) {
        var z = a.arrayMax, F = a.arrayMin, D = a.defined, B = a.destroyObjectProperties, f = a.each, h = a.erase, t = a.merge, r = a.pick;
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                var a = this, d = a.axis, g = d.horiz, n = a.options, f = n.label, h = a.label, b = n.to,
                    l = n.from, e = n.value, c = D(l) && D(b), E = D(e), u = a.svgElem, q = !u, x = [], A, H = n.color, k = r(n.zIndex, 0), G = n.events, x = {"class": "highcharts-plot-" + (c ? "band " : "line ") + (n.className || "")}, I = {}, L = d.chart.renderer, K = c ? "bands" : "lines", p = d.log2lin;
                d.isLog && (l = p(l), b = p(b), e = p(e));
                E ? (x = {
                        stroke: H,
                        "stroke-width": n.width
                    }, n.dashStyle && (x.dashstyle = n.dashStyle)) : c && (H && (x.fill = H), n.borderWidth && (x.stroke = n.borderColor, x["stroke-width"] = n.borderWidth));
                I.zIndex = k;
                K += "-" + k;
                (H = d.plotLinesAndBandsGroups[K]) || (d.plotLinesAndBandsGroups[K] =
                    H = L.g("plot-" + K).attr(I).add());
                q && (a.svgElem = u = L.path().attr(x).add(H));
                if (E) x = d.getPlotLinePath(e, u.strokeWidth()); else if (c) x = d.getPlotBandPath(l, b, n); else return;
                if (q && x && x.length) {
                    if (u.attr({d: x}), G)for (A in n = function (b) {
                        u.on(b, function (c) {
                            G[b].apply(a, [c])
                        })
                    }, G)n(A)
                } else u && (x ? (u.show(), u.animate({d: x})) : (u.hide(), h && (a.label = h = h.destroy())));
                ...
                var f = this.label, h = this.axis.chart.renderer;
                f || (f = {
                ...
                g = F(n);
                h = F(d);
                f.align(a, !1, {x: g, y: h, width: z(n) - g, height: z(d) - h});
                f.show()
            }, destroy: function () {
        ...
        a.AxisPlotLineOrBandExtension = {
            getPlotBandPath: function (a, d) {
                var g = this.getPlotLinePath(d, null, null, !0), n = this.getPlotLinePath(a, null, null, !0), f = this.horiz, h = 1;
                a = a < this.min && d < this.min || a > this.max && d > this.max;
                n && g ? (a && (n.flat = n.toString() === g.toString(), h = 0), n.push(f && g[4] === n[4] ? g[4] + h : g[4], f || g[5] !== n[5] ? g[5] : g[5] + h, f && g[1] === n[1] ? g[1] + h : g[1], f || g[2] !== n[2] ? g[2] : g[2] + h)) : n = null;
                return n
                ...
                for (var d = this.plotLinesAndBands, g = this.options, n = this.userOptions, m = d.length; m--;)d[m].id === a && d[m].destroy();
    ...
    (function (a) {
        ...
        a.Axis.prototype = {
            ...
            init: function (a, b) {
                ...
                -1 === c(this, a.axes) && (p ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
            ...
            defaultLabelFormatter: function () {
                var c =
                    this.axis, e = this.value, k = c.categories, l = this.dateTimeLabelFormat, d = r.lang, q = d.numericSymbols, d = d.numericSymbolMagnitude || 1E3, v = q && q.length, g, n = c.options.labels.format, c = c.isLog ? Math.abs(e) : c.tickInterval;
                if (n) g = b(n, this); else if (k) g = e; else if (l) g = a.dateFormat(l, e); else if (v && 1E3 <= c)for (; v-- && void 0 === g;)k = Math.pow(d, v + 1), c >= k && 0 === 10 * e % k && null !== q[v] && 0 !== e && (g = a.numberFormat(e / k, -1) + q[v]);
            ...
            getSeriesExtremes: function () {
                ...
                n(a.series, function (c) {
                    if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                        var p = c.options, k = p.threshold, C;
                        a.hasVisibleSeries = !0;
                        a.positiveValuesOnly && 0 >= k && (k = null);
                        if (a.isXAxis) p = c.xData, p.length && (c = B(p), u(c) || c instanceof Date || (p = e(p, function (a) {
                            return u(a)
                        }), c = B(p)), a.dataMin = Math.min(H(a.dataMin, p[0]), c), a.dataMax = Math.max(H(a.dataMax, p[0]), D(p))); else if (c.getExtremes(),
                                C = c.dataMax, c = c.dataMin, m(c) && m(C) && (a.dataMin = Math.min(H(a.dataMin, c), c), a.dataMax = Math.max(H(a.dataMax, C), C)), m(k) && (a.threshold = k), !p.softThreshold || a.positiveValuesOnly) a.softThreshold = !1
                    }
                })
            },
            translate: function (a, b, c, e, k, l) {
                var p = this.linkedParent || this, C = 1, d = 0, q = e ? p.oldTransA : p.transA;
                e = e ? p.oldMin : p.min;
            ...
            getPlotLinePath: function (a, b, c, e, k) {
                var p = this.chart, C = this.left, l = this.top, d, q, g = c && p.oldChartHeight || p.chartHeight, n = c && p.oldChartWidth || p.chartWidth, f;
                d = this.transB;
                ...
                u(k) ? this.horiz ? (d = l, q = g - this.bottom, a = c = h(a, C, C + this.width)) : (a = C, c = n - this.right, d = q = h(d, l, l + this.height)) : f = !0;
            ...
            getMinorTickPositions: function () {
                var a = this, b = a.options, c = a.tickPositions, e = a.minorTickInterval,
                    k = [], l = a.pointRangePadding || 0, d = a.min - l, l = a.max + l, q = l - d;
                if (q && q / e < a.len / 3)if (a.isLog) n(this.paddedTicks, function (b, c, p) {
                    c && k.push.apply(k, a.getLogTickPositions(e, p[c - 1], p[c], !0))
                }); else if (a.isDatetimeAxis && "auto" === b.minorTickInterval) k = k.concat(a.getTimeTicks(a.normalizeTimeTickInterval(e), d, l, b.startOfWeek)); else for (b = d + (c[0] - d) % e; b <= l && b !== k[0]; b += e)k.push(b);
                0 !== k.length && a.trimTicks(k);
                return k
            },
            adjustForMinRange: function () {
                var a = this.options, b = this.min, c = this.max, e, k = this.dataMax - this.dataMin >=
                    this.minRange, l, d, q, g, f, u;
                this.isXAxis && void 0 === this.minRange && !this.isLog && (m(a.min) || m(a.max) ? this.minRange = null : (n(this.series, function (a) {
                        g = a.xData;
                        for (d = f = a.xIncrement ? 1 : g.length - 1; 0 < d; d--)if (q = g[d] - g[d - 1], void 0 === l || q < l) l = q
                    }), this.minRange = Math.min(5 * l, this.dataMax - this.dataMin)));
                c - b < this.minRange && (u = this.minRange, e = (u - c + b) / 2, e = [b - e, H(a.min, b - e)], k && (e[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin), b = D(e), c = [b + u, H(a.max, b + u)], k && (c[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax),
            ...
            nameToX: function (a) {
                var b = E(this.categories), e = b ? this.categories : this.names, p = a.options.x, k;
                a.series.requireSorting = !1;
                m(p) || (p = !1 === this.options.uniqueNames ? a.series.autoIncrement() : c(a.name, e));
                -1 === p ? b ||
                    (k = e.length) : k = p;
            ...
            updateNames: function () {
                var a = this;
                0 < this.names.length && (this.names.length = 0, this.minRange = void 0, n(this.series || [], function (b) {
                    b.xIncrement = null;
            ...
            setAxisTranslation: function (a) {
                var b = this, c = b.max - b.min, e = b.axisPointRange || 0, p, k = 0, l = 0, d = b.linkedParent, g = !!b.categories, f =
                    b.transA, u = b.isXAxis;
                if (u || g || e) p = b.getClosest(), d ? (k = d.minPointOffset, l = d.pointRangePadding) : n(b.series, function (a) {
                        var c = g ? 1 : u ? H(a.options.pointRange, p, 0) : b.axisPointRange || 0;
                        a = a.options.pointPlacement;
                        e = Math.max(e, c);
                        b.single || (k = Math.max(k, q(a) ? 0 : c / 2), l = Math.max(l, "on" === a ? 0 : c))
                    }), d = b.ordinalSlope && p ? b.ordinalSlope / p : 1, b.minPointOffset = k *= d, b.pointRangePadding = l *= d, b.pointRange = Math.min(e, c), u && (b.closestPointRange = p);
                a && (b.oldTransA = f);
            ...
            setTickInterval: function (b) {
                var c = this, e = c.chart, p = c.options, k = c.isLog, d = c.log2lin, q = c.isDatetimeAxis, g = c.isXAxis, f = c.isLinked, h = p.maxPadding, G = p.minPadding, x = p.tickInterval, E = p.tickPixelInterval, y = c.categories, I = c.threshold, L = c.softThreshold, K, r, B, z;
                q || y || f || this.getTickAmount();
                B = H(c.userMin, p.min);
                z = H(c.userMax, p.max);
                f ? (c.linkedParent = e[c.coll][p.linkedTo], e = c.linkedParent.getExtremes(),
                        c.min = H(e.min, e.dataMin), c.max = H(e.max, e.dataMax), p.type !== c.linkedParent.options.type && a.error(11, 1)) : (!L && m(I) && (c.dataMin >= I ? (K = I, G = 0) : c.dataMax <= I && (r = I, h = 0)), c.min = H(B, K, c.dataMin), c.max = H(z, r, c.dataMax));
                k && (c.positiveValuesOnly && !b && 0 >= Math.min(c.min, H(c.dataMin, c.min)) && a.error(10, 1), c.min = t(d(c.min), 15), c.max = t(d(c.max), 15));
                c.range && m(c.max) && (c.userMin = c.min = B = Math.max(c.min, c.minFromRange()), c.userMax = z = c.max, c.range = null);
                w(c, "foundExtremes");
                c.beforePadding && c.beforePadding();
                c.adjustForMinRange();
                !(y || c.axisPointRange || c.usePercentage || f) && m(c.min) && m(c.max) && (d = c.max - c.min) && (!m(B) && G && (c.min -= d * G), !m(z) && h && (c.max += d * h));
                ...
                L && m(c.dataMin) && (I = I || 0, !m(B) && c.min < I && c.dataMin >= I ? c.min = I : !m(z) && c.max > I && c.dataMax <= I && (c.max = I));
                c.tickInterval = c.min === c.max || void 0 === c.min || void 0 === c.max ? 1 : f && !x && E === c.linkedParent.options.tickPixelInterval ?
                        x = c.linkedParent.tickInterval : H(x, this.tickAmount ? (c.max - c.min) / Math.max(this.tickAmount - 1, 1) : void 0, y ? 1 : (c.max - c.min) * E / Math.max(c.len, E));
                ...
                q || k || x || (c.tickInterval = A(c.tickInterval, null, l(c.tickInterval), H(p.allowDecimals, !(.5 < c.tickInterval && 5 > c.tickInterval && 1E3 < c.max && 9999 > c.max)), !!this.tickAmount));
                this.tickAmount || (c.tickInterval = c.unsquish());
                this.setTickPositions()
            },
            setTickPositions: function () {
                var a = this.options, b, c = a.tickPositions, e = a.tickPositioner, k = a.startOnTick, l = a.endOnTick;
            ...
            trimTicks: function (a, b, c) {
                var e = a[0], p = a[a.length - 1], k = this.minPointOffset || 0;
                if (!this.isLinked) {
                    if (b && -Infinity !== e) this.min = e; else for (; this.min - k > a[0];)a.shift();
                    if (c) this.max = p; else for (; this.max + k < a[a.length - 1];)a.pop();
            ...
            adjustTickAmount: function () {
                var a = this.tickInterval, b = this.tickPositions, c = this.tickAmount, e = this.finalTickAmt, k = b && b.length;
                if (k < c) {
            ...
            zoom: function (a, b) {
                var c = this.dataMin, e = this.dataMax, p = this.options, k = Math.min(c, H(p.min, c)), p = Math.max(e, H(p.max, e));
                if (a !== this.min || b !== this.max) this.allowZoomOutside || (m(c) && (a < k && (a = k), a > p && (a = p)),
                m(e) && (b < k && (b = k), b > p && (b = p))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {trigger: "zoom"});
                return !0
            },
            setAxisSize: function () {
                var a = this.chart, b = this.options, c = b.offsets || [0, 0, 0, 0], e = this.horiz, k = H(b.width, a.plotWidth - c[3] + c[1]), l = H(b.height, a.plotHeight - c[0] + c[2]), d = H(b.top, a.plotTop + c[0]), b = H(b.left, a.plotLeft + c[3]), c = /%$/;
            ...
            tickSize: function (a) {
                var b = this.options, c = b[a + "Length"], e = H(b[a + "Width"], "tick" === a && this.isXAxis ? 1 : 0);
            ...
            unsquish: function () {
                var a = this.options.labels, b = this.horiz,
                    c = this.tickInterval, e = c, k = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / c), l, q = a.rotation, g = this.labelMetrics(), f, u = Number.MAX_VALUE, h, G = function (a) {
                        a /= k || 1;
                        a = 1 < a ? Math.ceil(a) : 1;
                        return a * c
                    };
                b ? (h = !a.staggerLines && !a.step && (m(q) ? [q] : k < H(a.autoRotationLimit, 80) && a.autoRotation)) && n(h, function (a) {
                        var b;
                        if (a === q || a && -90 <= a && 90 >= a) f = G(Math.abs(g.h / Math.sin(d * a))), b = f + Math.abs(a / 360), b < u && (u = b, l = a, e = f)
                    }) : a.step || (e = G(g.h));
                this.autoRotation = h;
            ...
            getSlotWidth: function () {
                var a =
                    this.chart, b = this.horiz, c = this.options.labels, e = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), k = a.margin[3];
                return b && 2 > (c.step || 0) && !c.rotation && (this.staggerLines || 1) * this.len / e || !b && (k && k - a.spacing[3] || .33 * a.chartWidth)
            },
            renderUnsquish: function () {
                var a = this.chart, b = a.renderer, c = this.tickPositions, e = this.ticks, k = this.options.labels, l = this.horiz, d = this.getSlotWidth(), g = Math.max(1, Math.round(d - 2 * (k.padding || 5))), f = {}, u = this.labelMetrics(), h = k.style && k.style.textOverflow, G, m = 0, E, A;
                q(k.rotation) ||
                ...
                if (this.autoRotation) m > g && m > u.h ? f.rotation = this.labelRotation : this.labelRotation = 0; else if (d && (G = {width: g + "px"}, !h))for (G.textOverflow = "clip", E = c.length; !l && E--;)if (A = c[E], g = e[A].label) g.styles && "ellipsis" === g.styles.textOverflow ? g.css({textOverflow: "clip"}) : e[A].labelLength > d && g.css({width: d + "px"}), g.getBBox().height > this.len / c.length - (u.h - u.f) && (g.specCss = {textOverflow: "ellipsis"});
                f.rotation &&
                (G = {width: (m > .5 * a.chartHeight ? .33 * a.chartHeight : a.chartHeight) + "px"}, h || (G.textOverflow = "ellipsis"));
            ...
            addTitle: function (a) {
                var b =
                    this.chart.renderer, c = this.horiz, e = this.opposite, k = this.options.title, p;
            ...
            getOffset: function () {
                var a = this, b = a.chart, c = b.renderer, e = a.options, k = a.tickPositions, l = a.ticks, d = a.horiz, g = a.side, q = b.inverted ? [1, 0, 3, 2][g] : g, f, u, h = 0, G, x = 0, E = e.title, A = e.labels, w = 0, I = b.axisOffset, b = b.clipOffset, y = [-1, 1, 1, -1][g], L, K = e.className, r = a.axisParent, t = this.tickSize("tick");
                f = a.hasData();
                a.showAxis = u = f || H(e.showEmpty, !0);
                a.staggerLines = a.horiz && A.staggerLines;
                a.axisGroup || (a.gridGroup = c.g("grid").attr({zIndex: e.gridZIndex || 1}).addClass("highcharts-" + this.coll.toLowerCase() +
                    "-grid " + (K || "")).add(r), a.axisGroup = c.g("axis").attr({zIndex: e.zIndex || 2}).addClass("highcharts-" + this.coll.toLowerCase() + " " + (K || "")).add(r), a.labelGroup = c.g("axis-labels").attr({zIndex: A.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (K || "")).add(r));
                ...
                a.staggerLines && (w *= a.staggerLines, a.labelOffset = w * (a.opposite ? -1 : 1)); else for (L in l)l[L].destroy(), delete l[L];
                E && E.text && !1 !== E.enabled && (a.addTitle(u), u && (h = a.axisTitle.getBBox()[d ? "height" : "width"], G = E.offset, x = m(G) ? 0 : H(E.margin, d ? 5 : 10)));
                a.renderLine();
            ...
            getLinePath: function (a) {
                var b = this.chart, c = this.opposite, e = this.offset, k = this.horiz, p = this.left + (c ? this.width : 0) + e, e = b.chartHeight - this.bottom - (c ? this.height : 0) + e;
                c && (a *= -1);
                return b.renderer.crispLine(["M", k ? this.left : p, k ? e : this.top, "L", k ? b.chartWidth - this.right : p, k ? e : b.chartHeight - this.bottom], a)
            },
            renderLine: function () {
            ...
            getTitlePosition: function () {
                var a = this.horiz, b = this.left, c = this.top, e = this.len, k = this.options.title, l = a ? b : c, d = this.opposite, g = this.offset, q = k.x || 0, f = k.y || 0, n = this.chart.renderer.fontMetrics(k.style && k.style.fontSize, this.axisTitle).f, e = {
                    low: l + (a ? 0 : e),
                    middle: l + e / 2,
                    high: l + (a ? e : 0)
                }[k.align], b = (a ? c + this.height : b) + (a ? 1 : -1) * (d ? -1 : 1) * this.axisTitleMargin + (2 === this.side ? n : 0);
                return {
                    x: a ? e + q : b + (d ? this.width :
                            0) + g + q, y: a ? b + f - (d ? this.height : 0) + g : e + f
                }
            },
            ...
            renderTick: function (a, b) {
                var c = this.isLinked, e = this.ticks, k = this.chart.hasRendered && u(this.oldMin);
                if (!c || a >= this.min && a <= this.max) e[a] || (e[a] = new K(this, a)), k && e[a].isNew && e[a].render(b, !0, .1), e[a].render(b)
            },
            render: function () {
                var a = this, b = a.chart, c = a.options, e = a.isLog, l = a.lin2log,
                    d = a.isLinked, g = a.tickPositions, q = a.axisTitle, f = a.ticks, u = a.minorTicks, h = a.alternateBands, G = c.stackLabels, x = c.alternateGridColor, m = a.tickmarkOffset, E = a.axisLine, A = a.showAxis, w = F(b.renderer.globalAnimation), I, y;
                ...
                if (a.hasData() || d) a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function (b) {
                    ...
                    0 === p % 2 && c < a.max && y <= a.max + (b.polar ? -m : m) && (h[c] || (h[c] = new k(a)), I = c + m, h[c].options = {
                        from: e ? l(I) : I,
                        to: e ? l(y) : y,
                        color: x
                ...
                E && (E[E.isPlaced ? "animate" : "attr"]({d: this.getLinePath(E.strokeWidth())}), E.isPlaced = !0, E[A ? "show" : "hide"](!0));
            ...
            destroy: function (a) {
                var b = this, e = b.stacks, k, l = b.plotLinesAndBands, p, d;
                a || G(b);
            ...
            drawCrosshair: function (a, b) {
                var c, e = this.crosshair, k = H(e.snap, !0), l, d = this.cross;
                a || (a = this.cross && this.cross.e);
                this.crosshair && !1 !== (m(b) || !k) ? (k ? m(b) && (l = this.isXAxis ? b.plotX : this.len - b.plotY) : l = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), m(l) && (c = this.getPlotLinePath(b && (this.isXAxis ? b.x : H(b.stackY, b.y)), null, null, null, l) || null), m(c) ? (b = this.categories && !this.isRadial, d || (this.cross = d = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (b ? "category " :
                                "thin ") + e.className).attr({zIndex: H(e.zIndex, 2)}).add(), d.attr({
    ...
    (function (a) {
        var z = a.Axis, F = a.getMagnitude, D = a.map, B = a.normalizeTickInterval, f = a.pick;
        z.prototype.getLogTickPositions = function (a, t, r, m) {
            var d = this.options, g = this.len, n = this.lin2log, h = this.log2lin, w = [];
            m || (this._minorAutoInterval = null);
            if (.5 <= a) a = Math.round(a), w = this.getLinearTickPositions(a, t, r); else if (.08 <= a)for (var g = Math.floor(t), b, l, e, c, E, d = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; g < r + 1 && !E; g++)for (l = d.length, b = 0; b < l && !E; b++)e = h(n(g) * d[b]), e > t && (!m || c <= r) && void 0 !== c && w.push(c), c > r && (E = !0), c = e; else t = n(t), r = n(r), a = d[m ? "minorTickInterval" : "tickInterval"], a = f("auto" ===
            a ? null : a, this._minorAutoInterval, d.tickPixelInterval / (m ? 5 : 1) * (r - t) / ((m ? g / this.tickPositions.length : g) || 1)), a = B(a, null, F(a)), w = D(this.getLinearTickPositions(a, t, r), h), m || (this._minorAutoInterval = a / 5);
    ...
    (function (a) {
        var z = a.dateFormat, F = a.each, D = a.extend, B = a.format, f = a.isNumber, h = a.map, t = a.merge, r = a.pick, m = a.splat, d = a.syncTimeout, g = a.timeUnits;
        a.Tooltip =
            function () {
                this.init.apply(this, arguments)
            };
        a.Tooltip.prototype = {
            ...
            move: function (a, d, g, b) {
                var l = this, e = l.now, c = !1 !== l.options.animation && !l.isHidden && (1 < Math.abs(a - e.x) || 1 < Math.abs(d - e.y)), f = l.followPointer || 1 < l.len;
                D(e, {
                    x: c ? (2 * e.x + a) / 3 : a,
                    y: c ? (e.y + d) / 2 : d,
                ...
                var g, b = this.chart, l = b.inverted, e = b.plotTop, c = b.plotLeft, f = 0, u = 0, q, n;
                a = m(a);
                g = a[0].tooltipPos;
                this.followPointer && d && (void 0 === d.chartX && (d = b.pointer.normalize(d)), g = [d.chartX - b.plotLeft, d.chartY - e]);
                g || (F(a, function (a) {
                    q = a.series.yAxis;
                    n = a.series.xAxis;
                    f += a.plotX + (!l && n ? n.left - c : 0);
                    u += (a.plotLow ? (a.plotLow + a.plotHigh) / 2 : a.plotY) + (!l && q ? q.top - e : 0)
                }), f /= a.length, u /= a.length, g = [l ? b.plotWidth - u : f, this.shared && !l && 1 < a.length && d ? d.chartY - e : l ? b.plotHeight - f : u]);
                return h(g, Math.round)
            }, getPosition: function (a, d, g) {
                var b = this.chart, l = this.distance, e = {}, c = g.h || 0, f, u = ["y", b.chartHeight, d, g.plotY + b.plotTop, b.plotTop, b.plotTop + b.plotHeight], q = ["x", b.chartWidth, a, g.plotX + b.plotLeft, b.plotLeft, b.plotLeft + b.plotWidth], n = !this.followPointer && r(g.ttBelow, !b.inverted === !!g.negative), h = function (a, b, k, d, g, q) {
                    var p = k < d - l, f = d + l + k < b, u = d - l - k;
                    d += l;
                    if (n && f) e[a] = d; else if (!n && p) e[a] = u; else if (p) e[a] = Math.min(q - k, 0 > u - c ? u : u - c);
                    else if (f) e[a] = Math.max(g, d + c + k > b ? d : d + c); else return !1
                }, m = function (a, b, c, k) {
                    var d;
                    ...
                    !1 !== h.apply(0, u) ? !1 !== m.apply(0, q) || f || (k(!0), G()) : f ? e.x = e.y = 0 : (k(!0), G())
                };
                (b.inverted || 1 < this.len) && k();
                G();
                return e
            }, defaultFormatter: function (a) {
                var d = this.points || m(this), g;
                ...
                return g
                                  ...
                                  d) {
                var g, b = this.options, l, e = a, c, f = {}, u = [];
                ...
                !f || e.series && e.series.noSharedTooltip ? f = e.getLabelConfig() : (F(e, function (a) {
                    ...
                    }), f = {x: e[0].category, y: e[0].y}, f.points = u, e = e[0]);
                this.len = u.length;
                f = g.call(f, this);
                q = e.series;
                this.distance = r(q.tooltipOptions.distance, 16);
                !1 === f ? this.hide() :
                    (g = this.getLabel(), this.isHidden && g.attr({opacity: 1}).show(), this.split ? this.renderSplit(f, a) : (g.attr({text: f && f.join ? f.join("") : f}), g.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + r(e.colorIndex, q.colorIndex)), g.attr({stroke: b.borderColor || e.color || q.color || "#666666"}), this.updatePosition({
                            plotX: d,
                            plotY: l,
                            negative: e.negative,
                            ttBelow: e.ttBelow,
                ...
                var f = this, b = [], l = this.chart, e = l.renderer, c = !0, n = this.options, u, q = this.getLabel();
                F(d.slice(0, g.length + 1), function (a, d) {
                    d = g[d - 1] || {isHeader: !0, plotX: g[0].plotX};
                    var h = d.series || f, k = h.tt, G = d.series || {}, m = "highcharts-color-" + r(d.colorIndex, G.colorIndex, "none");
                    ...
                    d.isHeader ? (u = a.height,
                            G = Math.max(0, Math.min(d.plotX + l.plotLeft - G / 2, l.chartWidth - G))) : G = d.plotX + l.plotLeft - r(n.distance, 16) - G;
                    0 > G && (c = !1);
                ...
                d = a.series;
                var b = d.tooltipOptions, l = b.xDateFormat, e = d.xAxis, c = e && "datetime" ===
                    e.options.type && f(a.key), g = b[g + "Format"];
                c && !l && (l = this.getXDateFormat(a, b, e));
                c && l && (g = g.replace("{point.key}", "{point.key:" + l + "}"));
                return B(g, {point: a, series: d})
    ...
    (function (a) {
        var z = a.addEvent, F = a.attr, D = a.charts, B = a.color, f = a.css, h = a.defined, t = a.doc, r = a.each, m = a.extend, d = a.fireEvent, g = a.offset, n = a.pick, y = a.removeEvent, w = a.splat,
            b = a.Tooltip, l = a.win;
        ...
        a.Pointer.prototype = {
            init: function (a, c) {
                ...
                this.pinchDown = [];
                this.lastValidTouch = {};
                b && c.tooltip.enabled && (a.tooltip = new b(a, c.tooltip), this.followTouchMove = n(c.tooltip.followTouchMove, !0));
                this.setDOMEvents()
            }, zoomOption: function (a) {
                var b = this.chart, e = b.options.chart, d = e.zoomType || "", b = b.inverted;
                ...
                return m(a, {chartX: Math.round(c), chartY: Math.round(b)})
                ...
                r(a, function (a) {
                    ...
                    l = !b && a.directTouch;
                    a.visible && !l && n(a.options.enableMouseTracking, !0) && (g = a.searchPoint(d, !e && 0 > a.options.findNearestPointBy.indexOf("y"))) && g.series && c.push(g)
                });
                c.sort(function (a, c) {
                    var e = a.distX - c.distX, k = a.dist - c.dist, d = (c.series.group && c.series.group.zIndex) - (a.series.group && a.series.group.zIndex);
                    return 0 !== e && b ? e : 0 !== k ? k : 0 !== d ? d : a.series.index > c.series.index ? -1 : 1
                });
                if (b && c[0] && !c[0].series.noSharedTooltip)for (a = c.length; a--;)(c[a].x !== c[0].x || c[a].series.noSharedTooltip) && c.splice(a, 1);
                return c
                ...
                l ? g ? (k = [], r(d, function (a) {
                            var b = a.noSharedTooltip && g, c = !g && a.directTouch;
                            a.visible && !b && !c && n(a.options.enableMouseTracking, !0) && (a = a.searchKDTree({
                                clientX: e.clientX,
                                plotY: e.plotY
                            }, !b && 1 === a.kdDimensions)) && a.series && k.push(a)
                        }), 0 === k.length && (k = [e])) : k = [e] : q && !q.stickyTracking ? (g || (d = [q]), k = this.getKDPoints(d, g, f), e = a.find(k, function (a) {
                            return a.series === q
                ...
                return {hoverPoint: e, hoverSeries: q, hoverPoints: k}
            }, runPointActions: function (b, c) {
                var e = this.chart, d = e.tooltip, l = d ? d.shared :
                    !1, g = c || e.hoverPoint, f = g && g.series || e.hoverSeries;
                ...
                var c = this.chart, e = c.hoverSeries, d = c.hoverPoint,
                    g = c.hoverPoints, l = c.tooltip, f = l && l.shared ? g : d;
                ...
                var b = this.chart, e = b.options.chart, d = a.chartX, g = a.chartY,
                    l = this.zoomHor, f = this.zoomVert, n = b.plotLeft, k = b.plotTop, h = b.plotWidth, m = b.plotHeight, w, r = this.selectionMarker, p = this.mouseDownX, t = this.mouseDownY, y = e.panKey && a[e.panKey + "Key"];
                r && r.touch || (d < n ? d = n : d > n + h && (d = n + h), g < k ? g = k : g > k + m && (g = k + m), this.hasDragged = Math.sqrt(Math.pow(p - d, 2) + Math.pow(t - g, 2)), 10 < this.hasDragged && (w = b.isInsidePlot(p - n, t - k), b.hasCartesianSeries && (this.zoomX || this.zoomY) && w && !y && !r && (this.selectionMarker = r = b.renderer.rect(n, k, l ? 1 : h, f ? 1 : m, 0).attr({
                ...
                var b = this, e = this.chart, g = this.hasPinched;
                if (this.selectionMarker) {
                    var l = {
                        originalEvent: a,
                        xAxis: [],
                        yAxis: []
                    }, n = this.selectionMarker, A = n.attr ? n.attr("x") : n.x, w = n.attr ? n.attr("y") : n.y, k = n.attr ? n.attr("width") : n.width, G = n.attr ? n.attr("height") : n.height, I;
                    if (this.hasDragged || g) r(e.axes,
                        function (c) {
                            if (c.zoomEnabled && h(c.min) && (g || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                                var e = c.horiz, d = "touchend" === a.type ? c.minPixelPadding : 0, f = c.toValue((e ? A : w) + d), e = c.toValue((e ? A + k : w + G) - d);
                                l[c.coll].push({axis: c, min: Math.min(f, e), max: Math.max(f, e)});
                                I = !0
                            }
                        }), I && d(e, "selection", l, function (a) {
                        e.zoom(m(a, g ? {animation: !1} : null))
                    });
                    this.selectionMarker = this.selectionMarker.destroy();
                    g && this.scaleGroups()
                }
                e && (f(e.container, {cursor: e._cursor}), e.cancelClick = 10 < this.hasDragged, e.mouseIsDown = this.hasDragged =
                ...
                var c = this.chart;
                h(a.hoverChartIndex) && D[a.hoverChartIndex] && D[a.hoverChartIndex].mouseIsDown || (a.hoverChartIndex = c.index);
                b = this.normalize(b);
                b.returnValue = !1;
                ...
                var b = this.chart, e = b.hoverPoint, g = b.plotLeft, l = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (e && this.inClass(a.target,
                    "highcharts-tracker") ? (d(e.series, "click", m(a, {point: e})), b.hoverPoint && e.firePointEvent("click", a)) : (m(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - g, a.chartY - l) && d(b, "click", a)))
    ...
    (function (a) {
        var z = a.charts, F = a.each, D = a.extend, B = a.map,
            f = a.noop, h = a.pick;
        D(a.Pointer.prototype, {
            pinchTranslate: function (a, f, h, d, g, n) {
                ...
                var b = this.chart, l = a ? "x" : "y", e = a ? "X" : "Y", c = "chart" + e, m = a ? "width" : "height", u = b["plot" + (a ? "Left" : "Top")], q, x, A = w || 1, r = b.inverted, k = b.bounds[a ? "h" : "v"], G = 1 === f.length, I = f[0][c], t = h[0][c], K = !G && f[1][c], p = !G && h[1][c], C;
                h = function () {
                ...
                var r = this, m = r.chart, d = r.pinchDown, g = a.touches, n = g.length, t = r.lastValidTouch, w = r.hasZoom, b = r.selectionMarker, l = {}, e = 1 === n && (r.inClass(a.target, "highcharts-tracker") && m.runTrackerClick ||
                    r.runChartClick), c = {};
                1 < n && (r.initiated = !0);
                ...
                "touchstart" === a.type ? (F(g, function (a, b) {
                    ...
                    }), t.x = [d[0].chartX, d[1] && d[1].chartX], t.y = [d[0].chartY, d[1] && d[1].chartY], F(m.axes, function (a) {
                        if (a.zoomEnabled) {
                            var b = m.bounds[a.horiz ? "h" : "v"], c = a.minPixelPadding, e = a.toPixels(h(a.options.min, a.dataMin)), d = a.toPixels(h(a.options.max, a.dataMax)), g = Math.max(e, d);
                            b.min = Math.min(a.pos, Math.min(e, d) -
                                c);
                            b.max = Math.max(a.pos + a.len, g + c)
                        }
                    }), r.res = !0) : r.followTouchMove && 1 === n ? this.runPointActions(r.normalize(a)) : d.length && (b || (r.selectionMarker = b = D({
                            destroy: f,
                            touch: !0
                        }, m.plotBox)), r.pinchTranslate(d, g, l, b, c, t), r.hasPinched = w, r.scaleGroups(l, c), r.res && (r.res = !1, this.reset(!1, 0)))
            }, touch: function (f, r) {
                var m = this.chart, d, g;
                if (m.index !== a.hoverChartIndex) this.onContainerMouseLeave({relatedTarget: !0});
                a.hoverChartIndex = m.index;
                1 === f.touches.length ? (f = this.normalize(f), (g = m.isInsidePlot(f.chartX - m.plotLeft,
                        f.chartY - m.plotTop)) && !m.openMenu ? (r && this.runPointActions(f), "touchmove" === f.type && (r = this.pinchDown, d = r[0] ? 4 <= Math.sqrt(Math.pow(r[0].chartX - f.chartX, 2) + Math.pow(r[0].chartY - f.chartY, 2)) : !1), h(d, !0) && this.pinch(f)) : r && this.reset()) : 2 === f.touches.length && this.pinch(f)
    ...
    (function (a) {
        var z =
            a.addEvent, F = a.charts, D = a.css, B = a.doc, f = a.extend, h = a.noop, t = a.Pointer, r = a.removeEvent, m = a.win, d = a.wrap;
        if (m.PointerEvent || m.MSPointerEvent) {
            var g = {}, n = !!m.PointerEvent, y = function () {
                var a, d = [];
                d.item = function (a) {
                    return this[a]
                };
                for (a in g)g.hasOwnProperty(a) && d.push({pageX: g[a].pageX, pageY: g[a].pageY, target: g[a].target});
                return d
            }, w = function (b, d, e, c) {
            ...
            d(t.prototype, "init", function (a, d, e) {
                a.call(this, d, e);
                this.hasZoom && D(d.container, {"-ms-touch-action": "none", "touch-action": "none"})
            });
    ...
    (function (a) {
        var z, F = a.addEvent, D = a.css, B = a.discardElement, f = a.defined, h = a.each, t = a.isFirefox, r = a.marginNames, m = a.merge, d = a.pick, g = a.setAnimation, n = a.stableSort, y = a.win, w = a.wrap;
        ...
        z.prototype = {
            init: function (a, d) {
                ...
                var b = this.options, c = a.legendItem, g = a.legendLine, l = a.legendSymbol, f = this.itemHiddenStyle.color, b = d ? b.itemStyle.color : f, n = d ? a.color || f : f, h = a.options && a.options.marker, m = {fill: n}, k;
                ...
                var b = this.options, e = b.symbolPadding, b = !b.rtl, c = a._legendItemPos, d = c[0], c = c[1], g = a.checkbox;
                ...
                var b = this.group && this.group.alignAttr, e, c = this.clipHeight || this.legendHeight,
                    d = this.titleHeight;
                ...
                var a = this.padding, d = this.options.title, e = 0;
                d.text && (this.title || (this.title = this.chart.renderer.label(d.text, a - 3, a - 4, null, null, null, null, null, "legend-title").attr({zIndex: 1}).css(d.style).add(this.group)), a = this.title.getBBox(), e = a.height, this.offsetWidth = a.width, this.contentGroup.attr({translateY: e}));
                this.titleHeight = e
            }, setText: function (b) {
                var d = this.options;
                b.legendItem.attr({text: d.labelFormat ? a.format(d.labelFormat, b) : d.labelFormatter.call(b)})
                ...
                var b = this.chart, e = b.renderer, c = this.options, g = "horizontal" === c.layout, f = this.symbolWidth, q = c.symbolPadding, n = this.itemStyle, h = this.itemHiddenStyle, w = this.padding, k = g ? d(c.itemDistance, 20) : 0, G = !c.rtl, I = c.width, r = c.itemMarginBottom || 0, K = this.itemMarginTop, p = a.legendItem, y = !a.series, t = !y && a.series.drawLegendSymbol ? a.series : a, B = t.options,
                    B = this.createCheckboxForItem && B && B.showCheckbox, z = c.useHTML, D = a.options.className;
                p || (a.legendGroup = e.g("legend-item").addClass("highcharts-" + t.type + "-series highcharts-color-" + a.colorIndex + (D ? " " + D : "") + (y ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = p = e.text("", G ? f + q : -q, this.baseline || 0, z).css(m(a.visible ? n : h)).attr({
                    align: G ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup), this.baseline || (n = n.fontSize, this.fontMetrics = e.fontMetrics(n, p), this.baseline = this.fontMetrics.f +
                    3 + K, p.attr("y", this.baseline)), this.symbolHeight = c.symbolHeight || this.fontMetrics.f, t.drawLegendSymbol(this, a), this.setItemEvents && this.setItemEvents(a, p, z), B && this.createCheckboxForItem(a));
                ...
                g && this.itemX - w + f > (I || b.spacingBox.width - 2 * w - c.x) && (this.itemX = w, this.itemY += K + this.lastLineHeight +
                ...
                h(this.chart.series, function (b) {
                    var e = b && b.options;
                    b && d(e.showInLegend, f(e.linkedTo) ? !1 : void 0, !0) && (a = a.concat(b.legendItems || ("point" === e.legendType ?
                            b.data : b)))
                });
                return a
            }, adjustMargins: function (a, g) {
                var b = this.chart, c = this.options, l = c.align.charAt(0) + c.verticalAlign.charAt(0) + c.layout.charAt(0);
                c.floating || h([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (e, q) {
                    e.test(l) && !f(a[q]) && (b[r[q]] = Math.max(b[r[q]], b.legend[(q + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][q] * c[q % 2 ? "x" : "y"] + d(c.margin, 12) + g[q]))
                })
            }, render: function () {
                var a = this, d = a.chart, e = d.renderer, c = a.group, g, f, q, x, w = a.box, r = a.options, k = a.padding;
                a.itemX = k;
                a.itemY =
                    a.initialItemY;
                a.offsetWidth = 0;
                ...
                x += k;
                w || (a.box = w = e.rect().addClass("highcharts-legend-box").attr({r: r.borderRadius}).add(c), w.isNew = !0);
                w.attr({
                ...
                f && c.align(m(r, {width: q, height: x}), !0, "spacingBox");
                d.isResizing || this.positionCheckboxes()
            },
            handleOverflow: function (a) {
                var b = this, e = this.chart, c = e.renderer, g = this.options, f = g.y, q = this.padding, e = e.spacingBox.height + ("top" === g.verticalAlign ? -f : f) - q, f = g.maxHeight, n, m = this.clipRect, w = g.navigation, k = d(w.animation, !0), G = w.arrowSize || 12, I = this.nav, r = this.pages, y, p = this.allItems, t = function (a) {
                    a ? m.attr({height: a}) : m && (b.clipRect = m.destroy(), b.contentGroup.clip());
                ...
                f && (e = Math.min(e, f));
                r.length = 0;
                a > e && !1 !== w.enabled ? (this.clipHeight = n = Math.max(e - 20 - this.titleHeight - q, 0), this.currentPage = d(this.currentPage, 1), this.fullHeight = a, h(p, function (a, b) {
                        ...
                        c !== y && (y = c)
                    }), m || (m = b.clipRect = c.clipRect(0, q, 9999, 0), b.contentGroup.clip(m)), t(n), I || (this.nav = I = c.g().attr({zIndex: 1}).add(this.group),
                        this.up = c.symbol("triangle", 0, 0, G, G).on("click", function () {
                            b.scroll(-1, k)
                        }).add(I), this.pager = c.text("", 15, 10).addClass("highcharts-legend-navigation").css(w.style).add(I), this.down = c.symbol("triangle-down", 0, 0, G, G).on("click", function () {
                        b.scroll(1, k)
                    }).add(I)), b.scroll(0), a = e) : I && (t(), this.nav = I.destroy(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
                return a
            }, scroll: function (a, d) {
                var b = this.pages, c = b.length;
                a = this.currentPage + a;
                var f = this.clipHeight, l = this.options.navigation, q = this.pager,
                    n = this.padding;
                a > c && (a = c);
                0 < a && (void 0 !== d && g(d, this.chart), this.nav.attr({
                    ...
                    visibility: "visible"
                }), this.up.attr({"class": 1 === a ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"}), q.attr({text: a + "/" + c}), this.down.attr({
                    x: 18 + this.pager.getBBox().width,
                    "class": a === c ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"
                }), this.up.attr({fill: 1 === a ? l.inactiveColor : l.activeColor}).css({cursor: 1 === a ? "default" : "pointer"}), this.down.attr({
                    fill: a ===
                    c ? l.inactiveColor : l.activeColor
                }).css({cursor: a === c ? "default" : "pointer"}), d = -b[a - 1] + this.initialItemY, this.scrollGroup.animate({translateY: d}), this.currentPage = a, this.positionCheckboxes(d))
            }
        };
        a.LegendSymbolMixin = {
            drawRectangle: function (a, g) {
                var b = a.symbolHeight, c = a.options.squareSymbol;
                g.legendSymbol = this.chart.renderer.rect(c ? (a.symbolWidth - b) / 2 : 0, a.baseline - b + 1, c ? b : a.symbolWidth, b, d(a.options.symbolRadius, b / 2)).addClass("highcharts-point").attr({zIndex: 3}).add(g.legendGroup)
            }, drawLineMarker: function (a) {
                var b =
                    this.options, e = b.marker, c = a.symbolWidth, g = a.symbolHeight, f = g / 2, n = this.chart.renderer, h = this.legendGroup;
                a = a.baseline - Math.round(.3 * a.fontMetrics.b);
                var w;
                w = {"stroke-width": b.lineWidth || 0};
                ...
                e && !1 !== e.enabled && (b = Math.min(d(e.radius, f), f), 0 === this.symbol.indexOf("url") && (e = m(e, {
                    width: g,
                    height: g
                }), b = 0), this.legendSymbol = e = n.symbol(this.symbol, c / 2 - b, a - b, 2 * b, 2 * b, e).addClass("highcharts-point").add(h),
                    e.isMarker = !0)
            }
        };
    ...
    (function (a) {
        var z = a.addEvent, F = a.animate, D = a.animObject, B = a.attr, f = a.doc, h = a.Axis, t = a.createElement, r = a.defaultOptions, m = a.discardElement, d = a.charts, g = a.css, n = a.defined, y = a.each, w = a.extend, b = a.find, l = a.fireEvent, e = a.getStyle, c = a.grep, E = a.isNumber, u = a.isObject, q = a.isString, x = a.Legend, A = a.marginNames, H = a.merge,
            k = a.Pointer, G = a.pick, I = a.pInt, L = a.removeEvent, K = a.seriesTypes, p = a.splat, C = a.svg, M = a.syncTimeout, N = a.win, Q = a.Renderer, O = a.Chart = function () {
        ...
        O.prototype = {
            callbacks: [], getArgs: function () {
                ...
                var c = this.axes, e = this.series, d = this.pointer, k = this.legend, g = this.isDirtyLegend, f, p, n = this.hasCartesianSeries, q = this.isDirtyBox, h, m = this.renderer, v = m.isHidden(), G = [];
                ...
                var e, d = this.series, k;
                e = b(this.axes, c) || b(this.series, c);
                for (k = 0; !e && k < d.length; k++)e = b(d[k].points || [], c);
                return e
            }, getAxes: function () {
                var a = this, b = this.options, c = b.xAxis = p(b.xAxis || {}), b = b.yAxis = p(b.yAxis || {});
                y(c, function (a, b) {
                    a.index = b;
                    a.isX = !0
                });
                ...
                k = d.title = H({style: {color: "#333333", fontSize: d.isStock ? "16px" : "18px"}}, d.title, a);
                d = d.subtitle = H({style: {color: "#666666"}}, d.subtitle, b);
                ...
                var b =
                    0, c, e = this.renderer, d = this.spacingBox;
                y(["title", "subtitle"], function (a) {
                    var c = this[a], k = this.options[a], g;
                    c && (g = k.style.fontSize, g = e.fontMetrics(g, c).b, c.css({width: (k.width || d.width + k.widthAdjust) + "px"}).align(w({y: b + g + ("title" === a ? -3 : 2)}, k), !1, "spacingBox"), k.floating || k.verticalAlign || (b = Math.ceil(b + c.getBBox(k.useHTML).height)))
                }, this);
                ...
                var b =
                    this.options.chart, c = b.width, b = b.height, d = this.renderToClone || this.renderTo;
                ...
                this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), g(b, {
                    position: "absolute",
                    top: "-9999px",
                    display: "block"
                }), b.style.setProperty && b.style.setProperty("display", "block", "important"), f.body.appendChild(b), c && b.appendChild(c)
            }, setClassName: function (a) {
                this.container.className = "highcharts-container " + (a || "")
            }, getContainer: function () {
                var b, c = this.options, e = c.chart, k, g;
                b = this.renderTo;
                var p = a.uniqueKey(), l;
                ...
                this.container = b = t("div", {id: p}, l, this.renderToClone || b);
                ...
                var b = this, c = b.options.chart, d = b.renderTo, k = n(c.width), g = c.width || e(d, "width"), c = c.height || e(d, "height"), d = a ? a.target : N;
                ...
                d.getChartSize();
                b = k.globalAnimation;
                (b ? F : g)(d.container, {width: d.chartWidth + "px", height: d.chartHeight + "px"}, b);
                d.setChartSize(!0);
                ...
                var b = this.inverted, c = this.renderer, e = this.chartWidth, d =
                    this.chartHeight, k = this.options.chart, g = this.spacing, f = this.clipOffset, p, l, n, q;
                ...
                this.spacingBox = c.spacingBox = {x: g[3], y: g[0], width: e - g[3] - g[1], height: d - g[0] - g[2]};
                this.plotBox = c.plotBox = {x: p, y: l, width: n, height: q};
                ...
                d[A]({x: h / 2, y: h / 2, width: c - h - f % 2, height: e - h - f % 2, r: a.borderRadius});
                A = "animate";
                k || (A = "attr", this.plotBackground = k = b.rect().addClass("highcharts-plot-background").add());
                k[A](w);
                k.attr({fill: n || "none"}).shadow(a.plotShadow);
                ...
                A = "animate";
                g || (A = "attr", this.plotBorder = g = b.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add());
                g.attr({stroke: a.plotBorderColor, "stroke-width": a.plotBorderWidth || 0, fill: "none"});
                g[A](g.crisp({x: m, y: G, width: u, height: x}, -g.strokeWidth()));
                this.isDirtyBox = !1
                ...
                y(b, function (b) {
                    ...
                    q(c) && (c = ":previous" === c ? a.series[b.index - 1] : a.get(c)) && c.linkedParent !== b && (c.linkedSeries.push(b), b.linkedParent = c, b.visible = G(b.options.visible, c.options.visible, b.visible))
                })
                ...
                b.items && y(b.items, function (c) {
                    var e = w(b.style, c.style), d = I(e.left) + a.plotLeft, k = I(e.top) + a.plotTop + 12;
                    delete e.left;
                    delete e.top;
                ...
                var b = this, c = b.axes, e = b.series, k = b.container, g, f = k && k.parentNode;
                l(b, "destroy");
                d[b.index] = void 0;
                a.chartCount--;
                ...
                y("title subtitle chartBackground plotBackground plotBGImage plotBorder seriesGroup clipRect credits pointer rangeSelector legend resetZoomButton tooltip renderer".split(" "), function (a) {
                    var c = b[a];
                ...
                var a = this;
                return C || N != N.top || "complete" === f.readyState ? !0 : (f.attachEvent("onreadystatechange",
                        function () {
                ...
                y([this.callback].concat(this.callbacks),
                    function (a) {
    ...
    (function (a) {
        var z, F = a.each, D = a.extend, B = a.erase, f = a.fireEvent, h = a.format, t = a.isArray, r = a.isNumber, m = a.pick, d = a.removeEvent;
        z = a.Point = function () {
        };
        z.prototype = {
            init: function (a, d, f) {
                ...
                a.options.colorByPoint ? (d = a.options.colors || a.chart.options.colors, this.color = this.color ||
                        d[a.colorCounter], d = d.length, f = a.colorCounter, a.colorCounter++, a.colorCounter === d && (a.colorCounter = 0)) : f = a.colorIndex;
                ...
                var d = {}, g = this.series, f = g.options.keys, b = f || g.pointArrayMap || ["y"], l = b.length, e = 0, c = 0;
                if (r(a) || null === a) d[b[0]] = a; else if (t(a))for (!f && a.length > l && (g = typeof a[0], "string" === g ? d.name = a[0] : "number" === g && (d.x = a[0]), e++); c < l;)f && void 0 === a[e] || (d[b[c]] = a[e]), e++, c++; else"object" === typeof a &&
                ...
                var a =
                    this.series, d = a.zones, a = a.zoneAxis || "y", f = 0, h;
                for (h = d[f]; this[a] >= h.value;)h = d[++f];
                h && h.color && !this.options.color && (this.color = h.color);
                return h
            }, destroy: function () {
                var a = this.series.chart, f = a.hoverPoints, h;
                a.pointCount--;
                ...
                for (var a = ["graphic",
                    "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], d, f = 6; f--;)d = a[f], this[d] && (this[d] = this[d].destroy())
                ...
                var d = this.series, g = d.tooltipOptions, f = m(g.valueDecimals, ""), b = g.valuePrefix || "", l = g.valueSuffix || "";
                ...
                var g = this, b = this.series.options;
    ...
    (function (a) {
        var z = a.addEvent, F = a.animObject, D = a.arrayMax, B = a.arrayMin, f = a.correctFloat,
            h = a.Date, t = a.defaultOptions, r = a.defaultPlotOptions, m = a.defined, d = a.each, g = a.erase, n = a.extend, y = a.fireEvent, w = a.grep, b = a.isArray, l = a.isNumber, e = a.isString, c = a.merge, E = a.pick, u = a.removeEvent, q = a.splat, x = a.SVGElement, A = a.syncTimeout, H = a.win;
        a.Series = a.seriesType("line", null, {
            ...
            },
            {
                ...
                bindAxes: function () {
                    ...
                    d(b.axisTypes || [], function (k) {
                        d(e[k],
                            function (a) {
                                g = a.options;
                                if (c[k] === g.index || void 0 !== c[k] && c[k] === g.id || void 0 === c[k] && 0 === g.index) b.insert(a.series), b[k] = a, a.isDirty = !0
                            });
                        b[k] || b.optionalAxis === k || a.error(18, !0)
                    })
                },
                updateParallelArrays: function (a, b) {
                    var c = a.series, e = arguments, k = l(b) ? function (e) {
                ...
                autoIncrement: function () {
                    ...
                    e && (a = new h(b), "day" === e ? a = +a[h.hcSetDate](a[h.hcGetDate]() + c) : "month" === e ? a = +a[h.hcSetMonth](a[h.hcGetMonth]() + c) : "year" === e && (a = +a[h.hcSetFullYear](a[h.hcGetFullYear]() + c)), c = a - b);
                    this.xIncrement = b + c;
                    return b
                },
                setOptions: function (a) {
                    var b = this.chart, e = b.options.plotOptions, b = b.userOptions || {}, d = b.plotOptions || {}, k = e[this.type];
                    this.userOptions = a;
                    e = c(k, e.series, a);
                    ...
                    this.stickyTracking = E(a.stickyTracking, d[this.type] && d[this.type].stickyTracking, d.series && d.series.stickyTracking, this.tooltipOptions.shared && !this.noSharedTooltip ? !0 : e.stickyTracking);
                    ...
                    !e.negativeColor && !e.negativeFillColor || e.zones || a.push({
                        value: e[this.zoneAxis + "Threshold"] || e.threshold || 0, className: "highcharts-negative",
                        color: e.negativeColor, fillColor: e.negativeFillColor
                    });
                    a.length && m(a[a.length - 1].value) && a.push({color: this.color, fillColor: this.fillColor});
                    return e
                },
                getCyclic: function (a, b, c) {
                    var e, d = this.chart, k = this.userOptions, g = a + "Index", f = a + "Counter", l = c ? c.length : E(d.options.chart[a + "Count"], d[a + "Count"]);
                    b || (e = E(k[g], k["_" + g]), m(e) || (d.series.length || (d[f] = 0), k["_" + g] = e = d[f] % l, d[f] += 1), c && (b = c[e]));
                    void 0 !== e && (this[g] = e);
                    this[a] = b
                },
                getColor: function () {
                ...
                setData: function (c, g, f, q) {
                    var k = this, p = k.points, h = p && p.length || 0, n, m = k.options, u = k.chart, G = null, x = k.xAxis, r = m.turboThreshold, w = this.xData, A = this.yData, t = (n = k.pointArrayMap) && n.length;
                    c = c || [];
                    n = c.length;
                    g = E(g, !0);
                    if (!1 !== q && n && h === n && !k.cropped && !k.hasGroupedData && k.visible) d(c, function (a,
                        ...
                        if (r && n > r) {
                            ...
                            if (l(G))for (f = 0; f < n; f++)w[f] = this.autoIncrement(), A[f] = c[f]; else if (b(G))if (t)for (f = 0; f < n; f++)G = c[f], w[f] = G[0], A[f] = G.slice(1, t + 1); else for (f = 0; f < n; f++)G = c[f], w[f] = G[0], A[f] = G[1]; else a.error(12)
                        } else for (f = 0; f < n; f++)void 0 !== c[f] && (G = {series: k}, k.pointClass.prototype.applyOptions.apply(G, [c[f]]), k.updateParallelArrays(G,
                            f));
                        e(A[0]) && a.error(14, !0);
                        k.data = [];
                ...
                processData: function (b) {
                    var c = this.xData, e = this.yData, d = c.length, k;
                    k = 0;
                    var g, f, l = this.xAxis, q, h = this.options;
                    q = h.cropThreshold;
                    var n = this.getExtremesFromAll || h.getExtremesFromAll, m = this.isCartesian, h = l && l.val2lin, u = l &&
                        l.isLog, x, r;
                    if (m && !this.isDirty && !l.isDirty && !this.yAxis.isDirty && !b)return !1;
                    l && (b = l.getExtremes(), x = b.min, r = b.max);
                    if (m && this.sorted && !n && (!q || d > q || this.forceCrop))if (c[d - 1] < x || c[0] > r) c = [], e = []; else if (c[0] < x || c[d - 1] > r) k = this.cropData(this.xData, this.yData, x, r), c = k.xData, e = k.yData, k = k.start, g = !0;
                    for (q = c.length || 1; --q;)d = u ? h(c[q]) - h(c[q - 1]) : c[q] - c[q - 1], 0 < d && (void 0 === f || d < f) ? f = d : 0 > d && this.requireSorting && a.error(15);
                    this.cropped = g;
                    this.cropStart = k;
                ...
                cropData: function (a, b, c, e) {
                    var d = a.length, k = 0, g = d, f = E(this.cropShoulder, 1), l;
                ...
                generatePoints: function () {
                    var a = this.options.data, b = this.data, c, e = this.processedXData, d = this.processedYData, g = this.pointClass, f = e.length, l = this.cropStart || 0, h, n = this.hasGroupedData, m, u = [], x;
                    b || n || (b = [], b.length = a.length, b = this.data = b);
                    for (x = 0; x < f; x++)h = l + x, n ? (m = (new g).init(this,
                            [e[x]].concat(q(d[x]))), m.dataGroup = this.groupMap[x]) : (m = b[h]) || void 0 === a[h] || (b[h] = m = (new g).init(this, a[h], e[x])), m && (m.index = h, u[x] = m);
                    if (b && (f !== (c = b.length) || n))for (x = 0; x < c; x++)x !== l || n || (x += f), b[x] && (b[x].destroyElements(), b[x].plotX = void 0);
                    this.data = b;
                    this.points = u
                },
                getExtremes: function (a) {
                    var c = this.yAxis, e = this.processedXData, d, k = [], g = 0;
                    d = this.xAxis.getExtremes();
                    var f = d.min, q = d.max, h, n, m, u;
                    a = a || this.stackedYData || this.processedYData || [];
                    d = a.length;
                    for (u = 0; u < d; u++)if (n = e[u], m = a[u], h = (l(m,
                                !0) || b(m)) && (!c.positiveValuesOnly || m.length || 0 < m), n = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (e[u] || n) >= f && (e[u] || n) <= q, h && n)if (h = m.length)for (; h--;)null !== m[h] && (k[g++] = m[h]); else k[g++] = m;
                    this.dataMin = B(k);
                    this.dataMax = D(k)
                },
                translate: function () {
                    ...
                    this.generatePoints();
                    var a = this.options, b = a.stacking, c = this.xAxis, e = c.categories, d = this.yAxis, g = this.points, h = g.length, q = !!this.modifyValue, n = a.pointPlacement, u = "between" === n || l(n),
                        x = a.threshold, r = a.startFromThreshold ? x : 0, w, A, t, y, H = Number.MAX_VALUE;
                    "between" === n && (n = .5);
                    l(n) && (n *= E(a.pointRange || c.pointRange));
                    for (a = 0; a < h; a++) {
                        var B = g[a], z = B.x, D = B.y;
                        A = B.low;
                        var F = b && d.stacks[(this.negStacks && D < (r ? 0 : x) ? "-" : "") + this.stackKey], J;
                        d.positiveValuesOnly && null !== D && 0 >= D && (B.isNull = !0);
                        B.plotX = w = f(Math.min(Math.max(-1E5, c.translate(z, 0, 0, 0, 1, n, "flags" === this.type)), 1E5));
                        b && this.visible && !B.isNull && F && F[z] && (y = this.getStackIndicator(y, z, this.index), J = F[z], D = J.points[y.key], A = D[0], D =
                            D[1], A === r && y.key === F[z].base && (A = E(x, d.min)), d.positiveValuesOnly && 0 >= A && (A = null), B.total = B.stackTotal = J.total, B.percentage = J.total && B.y / J.total * 100, B.stackY = D, J.setOffset(this.pointXOffset || 0, this.barW || 0));
                        B.yBottom = m(A) ? d.translate(A, 0, 1, 0, 1) : null;
                        q && (D = this.modifyValue(D, B));
                        B.plotY = A = "number" === typeof D && Infinity !== D ? Math.min(Math.max(-1E5, d.translate(D, 0, 1, 0, 1)), 1E5) : void 0;
                ...
                setClip: function (a) {
                    var b = this.chart, c = this.options, e = b.renderer, d = b.inverted, k = this.clipBox, g = k || b.clipBox, f = this.sharedClipKey || ["_sharedClip", a && a.duration, a && a.easing, g.height,
                            c.xAxis, c.yAxis].join(), l = b[f], h = b[f + "m"];
                    l || (a && (g.width = 0, b[f + "m"] = h = e.clipRect(-99, d ? -b.plotLeft : -b.plotTop, 99, d ? b.chartWidth : b.chartHeight)), b[f] = l = e.clipRect(g), l.count = {length: 0});
                    a && !l.count[this.index] && (l.count[this.index] = !0, l.count.length += 1);
                    !1 !== c.clip && (this.group.clip(a || k ? l : b.clipRect), this.markerGroup.clip(h), this.sharedClipKey = f);
                    a || (l.count[this.index] && (delete l.count[this.index], --l.count.length), 0 === l.count.length && f && b[f] && (k || (b[f] = b[f].destroy()), b[f + "m"] && (b[f + "m"] = b[f + "m"].destroy())))
                },
                animate: function (a) {
                    var b = this.chart, c = F(this.options.animation), e;
                ...
                pointAttribs: function (a, b) {
                    var c = this.options.marker, e = a && a.options, d = e && e.marker || {}, g = this.color, k = e && e.color, f = a && a.color, e = E(d.lineWidth, c.lineWidth);
                    a = a && a.zone && a.zone.color;
                    g = k || a || f || g;
                    a = d.fillColor || c.fillColor || g;
                    g = d.lineColor || c.lineColor ||
                        g;
                    b && (c = c.states[b], b = d.states && d.states[b] || {}, e = E(b.lineWidth, c.lineWidth, e + E(b.lineWidthPlus, c.lineWidthPlus, 0)), a = b.fillColor || c.fillColor || a, g = b.lineColor || c.lineColor || g);
                    return {stroke: g, "stroke-width": e, fill: a}
                },
                destroy: function () {
                    var a = this, b = a.chart, c = /AppleWebKit\/533/.test(H.navigator.userAgent), e, f = a.data || [], l, h, q;
                    y(a, "destroy");
                    u(a);
                ...
                getGraphPath: function (a, b, c) {
                    var e = this, g = e.options, f = g.step, k, l = [], h = [], q;
                    a = a || e.points;
                    ...
                    d(a, function (d, k) {
                        ...
                        d.isNull && !m(b) && 0 < k ? q = !g.connectNulls : d.isNull && !b ? q = !0 : (0 === k || q ? k = ["M", d.plotX, d.plotY] : e.getPointSpline ? k = e.getPointSpline(a, d, k) : f ? (k = 1 === f ? ["L", u.plotX, p] : 2 === f ? ["L", (u.plotX + n) / 2, u.plotY, "L", (u.plotX + n) / 2, p] : ["L", n, u.plotY], k.push("L", n, p)) : k = ["L", n, p], h.push(d.x), f && h.push(d.x), l.push.apply(l, k), q = !1)
                    });
                    l.xMap = h;
                ...
                applyZones: function () {
                    var a = this, b = this.chart, c = b.renderer, e = this.zones, g, f, l = this.clips || [], h, q = this.graph, n = this.area, m = Math.max(b.chartWidth, b.chartHeight), u = this[(this.zoneAxis || "y") + "Axis"], x, r, w = b.inverted, A, t, y, H, B = !1;
                    e.length && (q || n) && u && void 0 !== u.min && (r = u.reversed, A = u.horiz, q && q.hide(), n && n.hide(), x = u.getExtremes(), d(e, function (e, d) {
                ...
                render: function () {
                    var a = this, b = a.chart, c, e = a.options, d = !!a.animate && b.renderer.isSVG && F(e.animation).duration,
                        g = a.visible ? "inherit" : "hidden", f = e.zIndex, l = a.hasRendered, h = b.seriesGroup, q = b.inverted;
                ...
                searchKDTree: function (a, b) {
                    function c(a, b, k, l) {
                        var h = b.point, q = e.kdAxisArray[k % l], n, p, u = h;
    ...
    (function (a) {
        var z = a.addEvent, F = a.animate, D = a.Axis, B = a.createElement, f = a.css, h = a.defined, t = a.each, r = a.erase, m = a.extend, d = a.fireEvent, g = a.inArray, n = a.isNumber, y = a.isObject, w = a.merge, b = a.pick, l = a.Point, e = a.Series, c = a.seriesTypes, E = a.setAnimation, u = a.splat;
        m(a.Chart.prototype, {
            addSeries: function (a, c, e) {
                var g, f = this;
                a && (c = b(c, !0),
                    d(f, "addSeries", {options: a}, function () {
                        g = f.initSeries(a);
                        f.isDirtyLegend = !0;
                        f.linkSeries();
                        c && f.redraw(e)
            ...
            addAxis: function (a, c, e, d) {
                var g = c ? "xAxis" : "yAxis", f = this.options;
                a = w(a, {index: this[g].length, isX: c});
                new D(this, a);
                f[g] = u(f[g] || {});
                f[g].push(a);
                b(e, !0) && this.redraw(d)
            ...
            showLoading: function (a) {
                ...
                e || (b.loadingDiv = e = B("div",
                    {className: "highcharts-loading highcharts-loading-hidden"}, null, b.container), b.loadingSpan = B("span", {className: "highcharts-loading-inner"}, null, e), z(b, "redraw", g));
                e.className = "highcharts-loading";
                b.loadingSpan.innerHTML = a || c.lang.loading;
                f(e, m(d.style, {zIndex: 10}));
                f(b.loadingSpan, d.labelStyle);
                b.loadingShown || (f(e, {
                    opacity: 0,
                    display: ""
                }), F(e, {opacity: d.style.opacity || .5}, {duration: d.showDuration || 0}));
                b.loadingShown = !0;
                g()
            },
            hideLoading: function () {
                ...
                b && (b.className =
                    "highcharts-loading highcharts-loading-hidden", F(b, {opacity: 0}, {
            ...
            update: function (a, c) {
                var e, d = {credits: "addCredits", title: "setTitle", subtitle: "setSubtitle"}, f = a.chart, l, q;
                if (f) {
                    w(!0, this.options.chart, f);
                    "className" in f && this.setClassName(f.className);
                    if ("inverted" in f || "polar" in f) this.propFromSeries(), l = !0;
                    "alignTicks" in f && (l = !0);
                    for (e in f)f.hasOwnProperty(e) && (-1 !== g("chart." + e, this.propsRequireUpdateSeries) && (q = !0), -1 !== g(e, this.propsRequireDirtyBox) && (this.isDirtyBox = !0));
                    "style" in f && this.renderer.setStyle(f.style)
                }
                for (e in a) {
                    if (this[e] && "function" === typeof this[e].update) this[e].update(a[e], !1); else if ("function" === typeof this[d[e]]) this[d[e]](a[e]);
                ...
                e = f && f.width;
                f = f && f.height;
                n(e) && e !== this.chartWidth || n(f) && f !== this.chartHeight ? this.setSize(e, f) : b(c, !0) && this.redraw()
            },
        ...
        m(l.prototype, {
            update: function (a, c, e, d) {
                function g() {
                    ...
                    y(a, !0) && (h && h.element && a && a.marker && a.marker.symbol && (f.graphic = h.destroy()), a && a.dataLabels && f.dataLabel && (f.dataLabel = f.dataLabel.destroy()));
                    n = f.index;
                ...
                var f = this, l = f.series, h = f.graphic, n, q = l.chart, m = l.options;
                c = b(c, !0);
        ...
        m(e.prototype, {
            addPoint: function (a, c, e, d) {
                var f = this.options, g = this.data, l = this.chart, h = this.xAxis, h = h && h.hasNames &&
                    h.names, n = f.data, q, m, u = this.xData, x, r;
                c = b(c, !0);
                q = {series: this};
                ...
                var d = this, f = d.data, g = f[a], l = d.points, h = d.chart, n = function () {
                ...
                var g = this, l = g.chart;
                !1 !== e ? d(g, "remove", null, f) : f()
            }, update: function (a, e) {
                var d = this, f = this.chart, g = this.userOptions, l = this.oldType || this.type, h = a.type || g.type || f.options.chart.type, n = c[l].prototype, q = ["group", "markerGroup", "dataLabelsGroup"], p;
                if (h && h !== l || void 0 !== a.zIndex) q.length = 0;
                t(q, function (a) {
                    q[a] = d[a];
                    delete d[a]
                });
                a = w(g, {animation: !1, index: this.index, pointStart: this.xData[0]}, {data: this.options.data}, a);
    ...
    (function (a) {
        var z = a.animObject, F = a.color, D = a.each, B = a.extend, f = a.isNumber, h = a.merge, t = a.pick, r = a.Series, m = a.seriesType, d = a.svg;
        m("column", "line", {
            borderRadius: 0,
            crisp: !0,
            groupPadding: .2,
            ...
            pointRange: null,
            states: {
                hover: {halo: !1, brightness: .1, shadow: !1}, select: {
            ...
            getColumnMetrics: function () {
                var a = this, d = a.options, f = a.xAxis, h = a.yAxis, b = f.reversed, l, e = {},
                    c = 0;
                !1 === d.grouping ? c = 1 : D(a.chart.series, function (b) {
                        var d = b.options, f = b.yAxis, g;
                        b.type === a.type && b.visible && h.len === f.len && h.pos === f.pos && (d.stacking ? (l = b.stackKey, void 0 === e[l] && (e[l] = c++), g = e[l]) : !1 !== d.grouping && (g = c++), b.columnIndex = g)
                    });
                var m = Math.min(Math.abs(f.transA) * (f.ordinalSlope || d.pointRange || f.closestPointRange || f.tickInterval || 1), f.len), u = m * d.groupPadding, q = (m - 2 * u) / (c || 1), d = Math.min(d.maxPointWidth || f.len, t(d.pointWidth, q * (1 - 2 * d.pointPadding)));
                a.columnMetrics = {
                    width: d, offset: (q - d) /
                    2 + (u + ((a.columnIndex || 0) + (b ? 1 : 0)) * q - m / 2) * (b ? -1 : 1)
                };
                return a.columnMetrics
            },
            crispCol: function (a, d, f, h) {
                var b = this.chart, g = this.borderWidth, e = -(g % 2 ? .5 : 0), g = g % 2 ? .5 : 1;
            ...
            translate: function () {
                var a = this, d = a.chart, f = a.options, h = a.dense = 2 > a.closestPointRange * a.xAxis.transA, h = a.borderWidth = t(f.borderWidth,
                    h ? 0 : 1), b = a.yAxis, l = a.translatedThreshold = b.getThreshold(f.threshold), e = t(f.minPointLength, 5), c = a.getColumnMetrics(), m = c.width, u = a.barW = Math.max(m, 1 + 2 * h), q = a.pointXOffset = c.offset;
                d.inverted && (l -= .5);
                f.pointPadding && (u = Math.ceil(u));
                r.prototype.translate.apply(a);
                D(a.points, function (c) {
                    var f = t(c.yBottom, l), g = 999 + Math.abs(f), g = Math.min(Math.max(-g, c.plotY), b.len + g), k = c.plotX + q, h = u, n = Math.min(g, f), r, x = Math.max(g, f) - n;
                    Math.abs(x) < e && e && (x = e, r = !b.reversed && !c.negative || b.reversed && c.negative, n = Math.abs(n -
                        l) > e ? f - e : l - (r ? e : 0));
                    c.barX = k;
                    c.pointWidth = m;
                    c.tooltipPos = d.inverted ? [b.len + b.pos - d.plotLeft - g, a.xAxis.len - k - h / 2, x] : [k + h / 2, g + b.pos - d.plotTop, x];
                    c.shapeType = "rect";
            ...
            pointAttribs: function (a, d) {
                var f = this.options, g, b = this.pointAttrToOptions || {};
                g = b.stroke || "borderColor";
                var l = b["stroke-width"] || "borderWidth", e = a && a.color || this.color, c = a[g] || f[g] || this.color || e, n = a[l] || f[l] || this[l] || 0, b = f.dashStyle;
                a && this.zones.length && (e = (e = a.getZone()) && e.color || a.options.color || this.color);
                d && (a = h(f.states[d], a.options.states && a.options.states[d] || {}), d = a.brightness, e = a.color || void 0 !== d && F(e).brighten(a.brightness).get() || e, c = a[g] || c, n = a[l] || n, b = a.dashStyle || b);
                g = {fill: e, stroke: c, "stroke-width": n};
            ...
            drawPoints: function () {
                var a =
                    this, d = this.chart, m = a.options, r = d.renderer, b = m.animationLimit || 250, l;
                D(a.points, function (e) {
                    var c = e.graphic;
                    if (f(e.plotY) && null !== e.y) {
                        l = e.shapeArgs;
                        if (c) c[d.pointCount < b ? "animate" : "attr"](h(l)); else e.graphic = c = r[e.shapeType](l).add(e.group || a.group);
            ...
            animate: function (a) {
                var f = this, g = this.yAxis, h = f.options, b = this.chart.inverted, l = {};
                d &&
                (a ? (l.scaleY = .001, a = Math.min(g.pos + g.len, Math.max(g.pos, g.toPixels(h.threshold))), b ? l.translateX = a - g.len : l.translateY = a, f.group.attr(l)) : (l[b ? "translateX" : "translateY"] = g.pos, f.group.animate(l, B(z(f.options.animation), {
                        step: function (a, b) {
                            f.group.attr({scaleY: Math.max(.001, b.pos)})
                        }
                    })), f.animate = null))
            },
            remove: function () {
    ...
    (function (a) {
        var z = a.addEvent, F = a.arrayMax, D = a.defined, B = a.each, f = a.extend, h = a.format, t = a.map, r = a.merge, m = a.noop, d = a.pick, g = a.relativeLength, n = a.Series, y = a.seriesTypes, w = a.stableSort;
        a.distribute = function (a, d) {
            ...
            for (a = t(a, function (a) {
                ...
                for (c = a.length; c--;)f = a[c], h = (Math.min.apply(0, f.targets) + Math.max.apply(0, f.targets)) / 2, f.pos = Math.min(Math.max(0, h - f.size / 2), d - f.size);
                c = a.length;
                for (f = !1; c--;)0 < c && a[c - 1].pos + a[c - 1].size > a[c].pos && (a[c - 1].size += a[c].size, a[c - 1].targets = a[c - 1].targets.concat(a[c].targets), a[c - 1].pos + a[c - 1].size > d && (a[c - 1].pos = d - a[c - 1].size), a.splice(c, 1), f = !0)
            }
            c = 0;
            B(a, function (a) {
                var b = 0;
        ...
        n.prototype.drawDataLabels =
            function () {
                var a = this, f = a.options, e = f.dataLabels, c = a.points, g, n, q = a.hasRendered || 0, m, w, t = d(e.defer, !0), k = a.chart.renderer;
                if (e.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(e), w = a.plotGroup("dataLabelsGroup", "data-labels", t && !q ? "hidden" : "visible", e.zIndex || 6), t && (w.attr({opacity: +q}), q || z(a, "afterAnimate", function () {
                    a.visible && w.show(!0);
                    w[f.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
                })), n = e, B(c, function (b) {
                    var c, l = b.dataLabel, q, p, u, x = b.connector, t = !l, A;
                    g = b.dlOptions ||
                    ...
                    !l || c && D(m) ? c && D(m) && (l ? q.text = m : (l = b.dataLabel = k[u ? "text" : "label"](m, 0, -9999, e.shape, null, null, e.useHTML, null, "data-label"), l.addClass("highcharts-data-label-color-" + b.colorIndex + " " + (e.className || "") + (e.useHTML ? "highcharts-tracker" : ""))), l.attr(q), l.css(A).shadow(e.shadow), l.added || l.add(w), a.alignDataLabel(b, l, e, null, t)) : (b.dataLabel = l.destroy(), x && (b.connector = x.destroy()))
                })
            };
        n.prototype.alignDataLabel = function (a, g, e, c, h) {
            var b = this.chart,
                l = b.inverted, n = d(a.plotX, -9999), m = d(a.plotY, -9999), r = g.getBBox(), k, w = e.rotation, t = e.align, E = this.visible && (a.series.forceDL || b.isInsidePlot(n, Math.round(m), l) || c && b.isInsidePlot(n, l ? c.x + 1 : c.y + c.height - 1, l)), y = "justify" === d(e.overflow, "justify");
            E && (k = e.style.fontSize, k = b.renderer.fontMetrics(k, g).b, c = f({
                x: l ? b.plotWidth - m : n,
                y: Math.round(l ? b.plotHeight - n : m),
                width: 0,
                height: 0
            }, c), f(e, {width: r.width, height: r.height}), w ? (y = !1, l = b.renderer.rotCorr(k, w), l = {
                    x: c.x + e.x + c.width / 2 + l.x, y: c.y + e.y + {
                        top: 0, middle: .5,
                        bottom: 1
                    }[e.verticalAlign] * c.height
                }, g[h ? "attr" : "animate"](l).attr({align: t}), n = (w + 720) % 360, n = 180 < n && 360 > n, "left" === t ? l.y -= n ? r.height : 0 : "center" === t ? (l.x -= r.width / 2, l.y -= r.height / 2) : "right" === t && (l.x -= r.width, l.y -= n ? 0 : r.height)) : (g.align(e, null, c), l = g.alignAttr), y ? a.isLabelJustified = this.justifyDataLabel(g, e, l, r, c, h) : d(e.crop, !0) && (E = b.isInsidePlot(l.x, l.y) && b.isInsidePlot(l.x + r.width, l.y + r.height)), e.shape && !w && g.attr({
                anchorX: a.plotX,
                anchorY: a.plotY
            }));
            E || (g.attr({y: -9999}), g.placed = !1)
        };
        n.prototype.justifyDataLabel =
            function (a, d, e, c, f, g) {
                var b = this.chart, l = d.align, h = d.verticalAlign, n, k, m = a.box ? 0 : a.padding || 0;
                n = e.x + m;
        ...
        y.pie && (y.pie.prototype.drawDataLabels = function () {
            var b = this, f = b.data,
                e, c = b.chart, g = b.options.dataLabels, h = d(g.connectorPadding, 10), m = d(g.connectorWidth, 1), r = c.plotWidth, w = c.plotHeight, y, k = g.distance, G = b.center, z = G[2] / 2, D = G[1], K = 0 < k, p, C, M, N, J = [[], []], O, v, P, S, R = [0, 0, 0, 0];
            b.visible && (g.enabled || b._hasPointLabels) && (B(f, function (a) {
                ...
                var l, n, m = d.length, q, u, x;
                if (m)for (b.sortByAngle(d, f - .5), 0 < k && (l = Math.max(0, D - z - k), n = Math.min(D + z + k, c.plotHeight), q = t(d, function (a) {
                    if (a.dataLabel)return x = a.dataLabel.getBBox().height || 21, {
                        target: a.labelPos[1] - l + x / 2,
                        size: x,
                        rank: a.y
                    }
                }), a.distribute(q, n + x - l)), S = 0; S < m; S++)e = d[S], M = e.labelPos, p = e.dataLabel, P = !1 === e.visible ? "hidden" : "inherit", u = M[1], q ? void 0 === q[S].pos ? P = "hidden" : (N = q[S].size, v = l + q[S].pos) : v = u, O = g.justify ? G[0] + (f ? -1 : 1) * (z + k) : b.getX(v < l + 2 || v > n -
                    2 ? u : v, f), p._attr = {visibility: P, align: M[6]}, p._pos = {
                    x: O + g.x + ({
                        left: h,
                        right: -h
                    }[M[6]] || 0), y: v + g.y - 10
                }, M.x = O, M.y = v, null === b.options.size && (C = p.getBBox().width, u = null, O - C < h ? (u = Math.round(C - O + h), R[3] = Math.max(u, R[3])) : O + C > r - h && (u = Math.round(O + C - r + h), R[1] = Math.max(u, R[1])), 0 > v - N / 2 ? R[0] = Math.max(Math.round(-v + N / 2), R[0]) : v + N / 2 > w && (R[2] = Math.max(Math.round(v + N / 2 - w), R[2])), p.sideOverflow = u)
            }), 0 === F(R) || this.verifyDataLabelOverflow(R)) && (this.placeDataLabels(), K && m && B(this.points, function (a) {
                var e;
                y = a.connector;
                if ((p = a.dataLabel) && p._pos && a.visible) {
                    P = p._attr.visibility;
                    if (e = !y) a.connector = y = c.renderer.path().addClass("highcharts-data-label-connector highcharts-color-" + a.colorIndex).add(b.dataLabelsGroup), y.attr({
                        "stroke-width": m,
                        stroke: g.connectorColor || a.color || "#666666"
                    });
                    y[e ? "attr" : "animate"]({d: b.connectorPath(a.labelPos)});
                    y.attr("visibility", P)
            ...
            return d(this.options.dataLabels.softConnector, !0) ? ["M", b +
                ("left" === a[6] ? 5 : -5), e, "C", b, e, 2 * a[2] - a[4], 2 * a[3] - a[5], a[2], a[3], "L", a[4], a[5]] : ["M", b + ("left" === a[6] ? 5 : -5), e, "L", a[2], a[3], "L", a[4], a[5]]
            ...
            var b = this.center, e = this.options, c = e.center, d = e.minSize || 80, f, h;
            null !== c[0] ? f = Math.max(b[2] - Math.max(a[1], a[3]), d) : (f = Math.max(b[2] - a[1] - a[3], d), b[0] += (a[3] - a[1]) / 2);
            null !== c[1] ? f = Math.max(Math.min(f, b[2] - Math.max(a[0], a[2])), d) : (f = Math.max(Math.min(f, b[2] - a[0] - a[2]), d), b[1] += (a[0] - a[2]) / 2);
            f < b[2] ? (b[2] = f, b[3] = Math.min(g(e.innerSize || 0, f), f), this.translate(b), this.drawDataLabels && this.drawDataLabels()) : h = !0;
            return h
        });
        y.column && (y.column.prototype.alignDataLabel =
            function (a, f, e, c, g) {
                var b = this.chart.inverted, h = a.series, l = a.dlBox || a.shapeArgs, m = d(a.below, a.plotY > d(this.translatedThreshold, h.yAxis.len)), w = d(e.inside, !!this.options.stacking);
                l && (c = r(l), 0 > c.y && (c.height += c.y, c.y = 0), l = c.y + c.height - h.yAxis.len, 0 < l && (c.height -= l), b && (c = {
    ...
    (function (a) {
        var z = a.Chart, F = a.each, D = a.pick, B = a.addEvent;
        z.prototype.callbacks.push(function (a) {
            function f() {
                var f = [];
                F(a.series || [], function (a) {
                    var h = a.options.dataLabels, d = a.dataLabelCollections || ["dataLabel"];
        ...
        z.prototype.hideOverlappingLabels = function (a) {
            var f = a.length, t, r, m, d, g, n, y, w, b, l = function (a, b, d, f, g, h, l, n) {
            ...
            for (r = 0; r < f; r++)for (m = a[r], t = r + 1; t < f; ++t)if (d = a[t], m && d && m !== d && m.placed && d.placed && 0 !== m.newOpacity && 0 !== d.newOpacity && (g = m.alignAttr,
                    n = d.alignAttr, y = m.parentGroup, w = d.parentGroup, b = 2 * (m.box ? 0 : m.padding), g = l(g.x + y.translateX, g.y + y.translateY, m.width - b, m.height - b, n.x + w.translateX, n.y + w.translateY, d.width - b, d.height - b))) (m.labelrank < d.labelrank ? m : d).newOpacity = 0;
            F(a, function (a) {
                var b, d;
    ...
    (function (a) {
        var z = a.addEvent, F = a.Chart, D = a.createElement, B = a.css, f = a.defaultOptions,
            h = a.defaultPlotOptions, t = a.each, r = a.extend, m = a.fireEvent, d = a.hasTouch, g = a.inArray, n = a.isObject, y = a.Legend, w = a.merge, b = a.pick, l = a.Point, e = a.Series, c = a.seriesTypes, E = a.svg;
        a = a.TrackerMixin = {
                ...
                a._hasTracking || (t(a.trackerGroups,
                    function (e) {
                        if (a[e]) {
                            ...
                            a.options.cursor && a[e].css(B).css({cursor: a.options.cursor})
                        }
                    }), a._hasTracking = !0)
            }, drawTrackerGraph: function () {
                var a = this, b = a.options, c = b.trackByArea, e = [].concat(c ? a.areaPath : a.graphPath), f = e.length, g = a.chart, h = g.pointer, l = g.renderer, n = g.options.tooltip.snap, m = a.tracker, p, r = function () {
                    if (g.hoverSeries !== a) a.onMouseOver()
                }, w = "rgba(192,192,192," +
                    (E ? .0001 : .002) + ")";
                if (f && !c)for (p = f + 1; p--;)"M" === e[p] && e.splice(p + 1, 0, e[p + 1] - n, e[p + 2], "L"), (p && "M" === e[p] || p === f) && e.splice(p, 0, "L", e[p - 2] + n, e[p - 1]);
                m ? m.attr({d: e}) : a.graph && (a.tracker = l.path(e).attr({
                        "stroke-linejoin": "round",
        ...
        r(F.prototype, {
            showResetZoom: function () {
                var a = this, b = f.lang, c = a.options.chart.resetZoomButton, d = c.theme, e = d.states, g = "chart" === c.relativeTo ? null : "plotBox";
                ...
                var a = this;
                m(a, "selection", {resetSelection: !0},
                    function () {
                        a.zoom()
                    })
            }, zoom: function (a) {
            ...
            select: function (a, c) {
                ...
                d.firePointEvent(a ? "select" : "unselect", {accumulate: c}, function () {
                    ...
                    c || t(f.getSelectedPoints(), function (a) {
                        a.selected && a !== d && (a.selected = a.options.selected = !1, e.options.data[g(a, e.data)] = a.options, a.setState(""), a.firePointEvent("unselect"))
                    })
                })
                ...
                var d = Math.floor(this.plotX), e = this.plotY, f = this.series, g = f.options.states[a] || {}, l =
                    h[f.type].marker && f.options.marker, n = l && !1 === l.enabled, m = l && l.states && l.states[a] || {}, q = !1 === m.enabled, p = f.stateMarkerGraphic, w = this.marker || {}, u = f.chart, t = f.halo, y, E = l && f.markerAttribs;
                a = a || "";
                if (!(a === this.state && !c || this.selected && "select" !== a || !1 === g.enabled || a && (q || n && !1 === m.enabled) || a && w.states && w.states[a] && !1 === w.states[a].enabled)) {
                    ...
                    if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" +
                        a), this.graphic.attr(f.pointAttribs(this, a)), y && this.graphic.animate(y, b(u.options.chart.animation, m.animation, l.animation)), p && p.hide(); else {
                        if (a && m) {
                            l = w.symbol || f.symbol;
                    ...
                    (d = g.halo) && d.size ?
                        (t || (f.halo = t = u.renderer.path().add(E ? f.markerGroup : f.group)), t[c ? "animate" : "attr"]({d: this.haloPath(d.size)}), t.attr({"class": "highcharts-halo highcharts-color-" + b(this.colorIndex, f.colorIndex)}), t.point = this, t.attr(r({
                            fill: this.color || f.color,
                            "fill-opacity": d.opacity,
                            zIndex: -1
                        }, d.attributes))) : t && t.point && t.point.haloPath && t.animate({d: t.point.haloPath(0)});
                    this.state = a
                }
            }, haloPath: function (a) {
        ...
        r(e.prototype,
            {
                ...
                var c = this, d = c.options, e = c.graph, f = d.states, g = d.lineWidth,
                    d = 0;
                a = a || "";
                if (c.state !== a && (t([c.group, c.markerGroup, c.dataLabelsGroup], function (b) {
                    ...
                    }), c.state = a, !f[a] || !1 !== f[a].enabled) && (a && (g = f[a].lineWidth || g + (f[a].lineWidthPlus || 0)), e && !e.dashstyle))for (g = {"stroke-width": g}, e.animate(g, b(c.chart.options.chart.animation, f[a] && f[a].animation)); c["zone-graph-" + d];)c["zone-graph-" + d].attr(g), d += 1
    ...
    (function (a) {
        var z = a.Chart, F = a.each, D = a.inArray, B = a.isArray, f = a.isObject, h = a.pick, t = a.splat;
        z.prototype.setResponsive = function (f) {
            var h = this.options.responsive, d = [], g = this.currentResponsive;
        ...
        z.prototype.currentOptions = function (a) {
            function h(a, d, m, r) {
                var b, g;
                for (b in a)if (!r && -1 < D(b, ["series", "xAxis", "yAxis"]))for (a[b] = t(a[b]), m[b] = [], g = 0; g < a[b].length; g++)d[b][g] && (m[b][g] = {}, h(a[b][g], d[b][g], m[b][g], r + 1)); else f(a[b]) ? (m[b] = B(a[b]) ? [] : {}, h(a[b], d[b] || {}, m[b], r + 1)) : m[b] = d[b] || null
            }
    ...
    (function (a) {
        var z = a.Axis, F = a.each, D = a.pick;
        a = a.wrap;
        a(z.prototype, "getSeriesExtremes", function (a) {
            var f = this.isXAxis, h, t, r = [], m;
            f && F(this.series, function (a, f) {
                a.useMapGeometry && (r[f] = a.xData, a.xData = [])
            });
            a.call(this);
            f && (h = D(this.dataMin, Number.MAX_VALUE), t = D(this.dataMax, -Number.MAX_VALUE), F(this.series, function (a, f) {
                a.useMapGeometry && (h = Math.min(h, D(a.minX, h)), t = Math.max(t, D(a.maxX, h)), a.xData = r[f], m = !0)
            }), m && (this.dataMin = h, this.dataMax = t))
        });
        a(z.prototype, "setAxisTranslation", function (a) {
            var f = this.chart, h = f.plotWidth / f.plotHeight, f =
                f.xAxis[0], t;
            a.call(this);
            "yAxis" === this.coll && void 0 !== f.transA && F(this.series, function (a) {
                a.preserveAspectRatio && (t = !0)
            });
            if (t && (this.transA = f.transA = Math.min(this.transA, f.transA), a = h / ((f.max - f.min) / (this.max - this.min)), a = 1 > a ? this : f, h = (a.max - a.min) * a.transA, a.pixelPadding = a.len - h, a.minPixelPadding = a.pixelPadding / 2, h = a.fixTo)) {
    ...
    (function (a) {
        var z = a.Axis, F = a.Chart, D = a.color, B, f = a.each, h = a.extend, t = a.isNumber, r = a.Legend, m = a.LegendSymbolMixin, d = a.noop, g = a.merge, n = a.pick, y = a.wrap;
        ...
        h(B.prototype, {
            ...
            init: function (a, b) {
                var d = "vertical" !== a.options.legend.layout, e;
                this.coll = "colorAxis";
                e = g(this.defaultColorAxisOptions, {side: d ? 2 : 1, reversed: !d}, b, {
                    opposite: !d,
                    showEmpty: !1,
                    title: null
                });
            ...
            tweenColors: function (a, b, d) {
                var e;
                b.rgba.length && a.rgba.length ? (a = a.rgba, b = b.rgba, e = 1 !== b[3] || 1 !== a[3], a = (e ? "rgba(" : "rgb(") + Math.round(b[0] + (a[0] - b[0]) * (1 - d)) + "," + Math.round(b[1] + (a[1] - b[1]) * (1 - d)) + "," + Math.round(b[2] + (a[2] - b[2]) * (1 - d)) + (e ? "," + (b[3] + (a[3] - b[3]) * (1 - d)) : "") + ")") : a = b.input || "none";
                return a
            },
            initDataClasses: function (a) {
                var b = this, d = this.chart, e, c = 0, h = d.options.chart.colorCount, n = this.options, m = a.dataClasses.length;
                this.dataClasses = e = [];
                this.legendItems = [];
                f(a.dataClasses, function (a,
                    ...
                    a = g(a);
                    e.push(a);
                    a.color || ("category" === n.dataClassColor ? (f = d.options.colors, h = f.length, a.color = f[c], a.colorIndex = c, c++, c === h && (c = 0)) : a.color = b.tweenColors(D(n.minColor), D(n.maxColor), 2 > m ? .5 : f / (m - 1)))
                })
            },
            ...
            setAxisSize: function () {
                ...
                a ? (this.left = d = a.attr("x"), this.top = e = a.attr("y"), this.width = c = a.attr("width"), this.height = a = a.attr("height"), this.right = b.chartWidth - d - c, this.bottom = b.chartHeight - e - a, this.len = this.horiz ? c : a, this.pos = this.horiz ? d : e) : this.len = (this.horiz ? d.symbolWidth : d.symbolHeight) || this.defaultLegendLength
            },
            toColor: function (a, b) {
                var d = this.stops, e, c, f = this.dataClasses, g, h;
            ...
            setLegendColor: function () {
                var a,
                    b = this.options, d = this.reversed;
                a = d ? 1 : 0;
                d = d ? 0 : 1;
            ...
            drawLegendSymbol: function (a, b) {
                var d = a.padding, e = a.options, c = this.horiz, f = n(e.symbolWidth, c ? this.defaultLegendLength : 12), g = n(e.symbolHeight, c ? 12 : this.defaultLegendLength), h = n(e.labelPadding, c ? 16 : 30), e = n(e.itemDistance, 10);
                this.setLegendColor();
            ...
            drawCrosshair: function (a, b) {
                var d = b && b.plotX, e = b && b.plotY, c, f = this.pos, g = this.len;
                b && (c = this.toPixels(b[b.series.colorKey]), c < f ? c = f - 2 : c > f + g && (c = f + g + 2), b.plotX =
                    c, b.plotY = this.len - c, z.prototype.drawCrosshair.call(this, a, b), b.plotX = d, b.plotY = e, this.cross && (this.cross.addClass("highcharts-coloraxis-marker").add(this.legendGroup), this.cross.attr({fill: this.crosshair.color})))
            },
            getPlotLinePath: function (a, b, d, e, c) {
                return t(c) ? this.horiz ? ["M", c - 4, this.top - 6, "L", c + 4, this.top - 6, c, this.top, "Z"] : ["M", this.left, c, "L", this.left - 6, c + 6, this.left - 6, c - 6, "Z"] : z.prototype.getPlotLinePath.call(this, a, b, d, e)
            },
            update: function (a, b) {
                var d = this.chart, e = d.legend;
            ...
            getDataClassLegendSymbols: function () {
                var g = this, b = this.chart, l = this.legendItems, e = b.options.legend, c = e.valueDecimals, n = e.valueSuffix || "", r;
                l.length || f(this.dataClasses, function (e, t) {
                    var q = !0, u = e.from, k = e.to;
                    r = "";
        ...
        y(r.prototype, "getAllItems", function (a) {
            ...
            d && d.options && (d.options.showInLegend && (d.options.dataClasses ? b = b.concat(d.getDataClassLegendSymbols()) : b.push(d)), f(d.series, function (a) {
    ...
    (function (a) {
        var z = a.defined, F = a.each, D = a.noop, B = a.seriesTypes;
        a.colorPointMixin = {
            isValid: function () {
                return null !== this.value
            }, setVisible: function (a) {
                var f = this, t = a ? "show" : "hide";
        ...
        a.colorSeriesMixin = {
            ...
            translateColors: function () {
                ...
                F(this.data, function (f) {
                    var d = f[r];
                    if (d = f.options.color || (f.isNull ? h : t && void 0 !== d ? t.toColor(d, f) : f.color || a.color)) f.color = d
                })
            },
    ...
    (function (a) {
        ...
        var D = a.addEvent, B = a.Chart, f = a.doc, h = a.each, t = a.extend, r = a.merge, m = a.pick;
        a = a.wrap;
        ...
        F.prototype.update = function (a) {
            var d = this.chart, f = d.options.mapNavigation, h, w, b, l, e, c = function (a) {
        ...
        F.prototype.updateEvents = function (a) {
            var d = this.chart;
            m(a.enableDoubleClickZoom, a.enabled) || a.enableDoubleClickZoomTo ? this.unbindDblClick = this.unbindDblClick || D(d.container, "dblclick", function (a) {
                        d.pointer.onContainerDblClick(a)
                    }) : this.unbindDblClick && (this.unbindDblClick = this.unbindDblClick());
            m(a.enableMouseWheelZoom, a.enabled) ? this.unbindMouseWheel = this.unbindMouseWheel || D(d.container, void 0 === f.onmousewheel ?
        ...
        t(B.prototype, {
            fitToBox: function (a, f) {
                ...
                var b = this.xAxis[0], d = b.max - b.min, e = m(f, b.min + d / 2), c = d * a, d = this.yAxis[0], g =
                    d.max - d.min, n = m(h, d.min + g / 2), g = g * a, e = this.fitToBox({
                ...
                }), c = e.x <= b.dataMin && e.width >= b.dataMax - b.dataMin && e.y <= d.dataMin && e.height >= d.dataMax - d.dataMin;
                r && (b.fixTo = [r - b.pos, f]);
                t && (d.fixTo = [t - d.pos, h]);
                void 0 === a || c ? (b.setExtremes(void 0, void 0, !1), d.setExtremes(void 0, void 0, !1)) : (b.setExtremes(e.x, e.x + e.width, !1), d.setExtremes(e.y, e.y + e.height, !1));
                this.redraw()
            }
        });
    ...
    (function (a) {
        var z = a.extend, F = a.pick, D = a.Pointer;
        a = a.wrap;
        z(D.prototype, {
            onContainerDblClick: function (a) {
                var f = this.chart;
                a = this.normalize(a);
                f.options.mapNavigation.enableDoubleClickZoomTo ? f.pointer.inClass(a.target, "highcharts-tracker") && f.hoverPoint && f.hoverPoint.zoomTo() : f.isInsidePlot(a.chartX - f.plotLeft, a.chartY - f.plotTop) && f.mapZoom(.5, f.xAxis[0].toValue(a.chartX),
                        f.yAxis[0].toValue(a.chartY), a.chartX, a.chartY)
            }, onContainerMouseWheel: function (a) {
                var f = this.chart, h;
                a = this.normalize(a);
                h = a.detail || -(a.wheelDelta / 120);
                f.isInsidePlot(a.chartX - f.plotLeft, a.chartY - f.plotTop) && f.mapZoom(Math.pow(f.options.mapNavigation.mouseWheelSensitivity, h), f.xAxis[0].toValue(a.chartX), f.yAxis[0].toValue(a.chartY), a.chartX, a.chartY)
            }
        });
        ...
        a(D.prototype, "pinchTranslate", function (a, f, h, t, r, m, d) {
            ...
            "map" === this.chart.options.chart.type && this.hasZoom && (a = t.scaleX > t.scaleY, this.pinchTranslateDirection(!a, f, h, t, r, m, d, a ? t.scaleX : t.scaleY))
        })
    })(J);
    (function (a) {
        var z = a.color, F = a.ColorAxis, D = a.colorPointMixin, B = a.each, f = a.extend, h = a.isNumber, t = a.map, r = a.merge, m = a.noop, d = a.pick, g = a.isArray, n = a.Point, y = a.Series, w = a.seriesType, b = a.seriesTypes, l = a.splat, e = void 0 !== a.doc.documentElement.style.vectorEffect;
        w("map", "scatter", {
            allAreas: !0,
            animation: !1,
            nullColor: "#f7f7f7",
            ...
            pointArrayMap: ["value"],
            getBox: function (b) {
                var c = Number.MAX_VALUE, e = -c, f = c, g = -c, l = c, n = c, k = this.xAxis, m = this.yAxis, r;
                B(b || [], function (b) {
                    if (b.path) {
                        "string" === typeof b.path && (b.path = a.splitPath(b.path));
                        var k = b.path || [], m = k.length, q = !1, t = -c, u = c, w = -c, x = c, v = b.properties;
                        if (!b._foundBox) {
                            for (; m--;)h(k[m]) && (q ? (t = Math.max(t, k[m]), u = Math.min(u, k[m])) : (w = Math.max(w, k[m]), x = Math.min(x, k[m])), q = !q);
                            b._midX =
                ...
                r && (this.minY = Math.min(l, d(this.minY, c)), this.maxY = Math.max(g, d(this.maxY, -c)), this.minX = Math.min(f, d(this.minX, c)), this.maxX = Math.max(e, d(this.maxX, -c)), k && void 0 === k.options.minRange &&
                (k.minRange = Math.min(5 * n, (this.maxX - this.minX) / 5, k.minRange || c)), m && void 0 === m.options.minRange && (m.minRange = Math.min(5 * n, (this.maxY - this.minY) / 5, m.minRange || c)))
            },
            getExtremes: function () {
            ...
            translatePath: function (a) {
                var b = !1, c = this.xAxis, d = this.yAxis, e = c.min, f = c.transA, c = c.minPixelPadding,
                    g = d.min, k = d.transA, d = d.minPixelPadding, l, m = [];
                if (a)for (l = a.length; l--;)h(a[l]) ? (m[l] = b ? (a[l] - e) * f + c : (a[l] - g) * k + d, b = !b) : m[l] = a[l];
                return m
            },
            setData: function (b, d, e, f) {
                var c = this.options, m = this.chart.options.chart, n = m && m.map, k = c.mapData, q = c.joinBy, u = null === q, w = c.keys || this.pointArrayMap, E = [], p = {}, C, z = this.chart.mapTransforms;
                ...
                b && B(b, function (a, d) {
                    var e = 0;
                    if (h(a)) b[d] = {value: a}; else if (g(a)) {
                        b[d] = {};
                        !c.keys && a.length >
                ...
                this.getBox(b);
                if (this.chart.mapTransforms = z = m && m.mapTransforms || k && k["hc-transform"] || z)for (C in z)z.hasOwnProperty(C) && C.rotation && (C.cosAngle = Math.cos(C.rotation), C.sinAngle = Math.sin(C.rotation));
                if (k) {
                    ...
                    c.allAreas ? (this.getBox(k), b = b || [], q[1] && B(b, function (a) {
                            ...
                            q[0] && -1 !== E.indexOf("|" + a[q[0]] + "|") || (b.push(r(a, {value: null})), f = !1)
                        })) : this.getBox(E)
                }
            ...
            translate: function () {
                var a = this, b = a.xAxis, d = a.yAxis, e = a.doFullTranslate();
                a.generatePoints();
                B(a.data, function (c) {
                    c.plotX = b.toPixels(c._midX, !0);
                    c.plotY = d.toPixels(c._midY, !0);
                    e && (c.shapeType = "path", c.shapeArgs = {d: a.translatePath(c.path)})
                });
                a.translateColors()
            },
            pointAttribs: function (a, d) {
            ...
            drawPoints: function () {
                var a =
                    this, d = a.xAxis, f = a.yAxis, g = a.group, h = a.chart, l = h.renderer, m, k, n, r, t = this.baseTrans, w, p, y, z, D;
                ...
                a.doFullTranslate() ? (h.hasRendered && B(a.points, function (b) {
                    ...
                    }), a.group = a.transformGroup, b.column.prototype.drawPoints.apply(a), a.group = g, B(a.points, function (a) {
                        ...
                        scaleX: 1,
                        scaleY: 1
                    })) : (m = d.transA / t.transAX, k = f.transA / t.transAY, n = d.toPixels(t.originX, !0), r = f.toPixels(t.originY, !0), .99 < m && 1.01 > m && .99 < k && 1.01 > k && (k = m = 1, n = Math.round(n),
                        r = Math.round(r)), w = this.transformGroup, h.renderer.globalAnimation ? (p = w.attr("translateX"), y = w.attr("translateY"), z = w.attr("scaleX"), D = w.attr("scaleY"), w.attr({animator: 0}).animate({animator: 1}, {
                            step: function (a, b) {
                                w.attr({
                        ...
                        })) : w.attr({translateX: n, translateY: r, scaleX: m, scaleY: k}));
                e || a.group.element.setAttribute("stroke-width", a.options[a.pointAttrToOptions && a.pointAttrToOptions["stroke-width"] || "borderWidth"] /
                    (m || 1));
            ...
            animate: function (a) {
                ...
                this.chart.renderer.isSVG && (!0 === b && (b = {duration: 1E3}), a ? c.attr({
                        translateX: f + d.len / 2, translateY: g +
                        e.len / 2, scaleX: .001, scaleY: .001
            ...
            applyOptions: function (a, b) {
                ...
                var a = this, b = +new Date, d = z(this.series.pointAttribs(a).fill), e = z(this.series.pointAttribs(a, "hover").fill), f = a.series.options.states.normal.animation, g = f && (f.duration || 500);
                g && 4 === d.rgba.length && 4 === e.rgba.length && "select" !== a.state && (clearTimeout(a.colorInterval), a.colorInterval = setInterval(function () {
                    var c = (new Date - b) / g, f = a.graphic;
                    1 < c && (c = 1);
    ...
    (function (a) {
        var z = a.seriesType, F = a.seriesTypes;
    ...
    (function (a) {
        var z =
            a.arrayMax, F = a.arrayMin, D = a.Axis, B = a.color, f = a.each, h = a.isNumber, t = a.noop, r = a.pick, m = a.pInt, d = a.Point, g = a.Series, n = a.seriesType, y = a.seriesTypes;
        n("bubble", "scatter", {
            dataLabels: {
                formatter: function () {
                    return this.point.z
            ...
            getRadii: function (a, b, d, e) {
                var c, f, g, h = this.zData, l = [], m = this.options, n = "width" !== m.sizeBy, k = m.zThreshold, r = b - a;
                f = 0;
                for (c = h.length; f < c; f++)g = h[f], m.sizeByAbsoluteValue &&
                null !== g && (g = Math.abs(g - k), b = Math.max(b - k, Math.abs(a - k)), a = 0), null === g ? g = null : g < a ? g = d / 2 - 1 : (g = 0 < r ? (g - a) / r : .5, n && 0 <= g && (g = Math.sqrt(g)), g = Math.ceil(d + g * (e - d)) / 2), l.push(g);
                this.radii = l
            },
            animate: function (a) {
                ...
                a || (f(this.points, function (a) {
                    var d = a.graphic, c;
                    d && d.width && (c = {x: d.x, y: d.y, width: d.width, height: d.height}, d.attr({
                        x: a.plotX,
                        y: a.plotY,
                        width: 1,
                        height: 1
            ...
            translate: function () {
                var d, b = this.data, f, e, c = this.radii;
                y.scatter.prototype.translate.call(this);
                for (d = b.length; d--;)f = b[d], e = c ? c[d] : 0, h(e) && e >= this.minPxSize / 2 ? (f.marker = a.extend(f.marker, {
                        radius: e,
                        width: 2 * e,
                        height: 2 * e
                    }), f.dlBox = {
        ...
        D.prototype.beforePadding = function () {
            var a = this, b = this.len, d = this.chart, e = 0, c = b, g = this.isXAxis,
                n = g ? "xData" : "yData", q = this.min, t = {}, y = Math.min(d.plotWidth, d.plotHeight), B = Number.MAX_VALUE, k = -Number.MAX_VALUE, D = this.max - q, I = b / D, J = [];
            f(this.series, function (b) {
                var c = b.options;
                !b.bubblePadding || !b.visible && d.options.chart.ignoreHiddenSeries || (a.allowZoomOutside = !0, J.push(b), g && (f(["minSize", "maxSize"], function (a) {
                    var b = c[a], d = /%$/.test(b), b = m(b);
                    t[a] = d ? y * b / 100 : b
                }), b.minPxSize = t.minSize, b.maxPxSize = Math.max(t.maxSize, t.minSize), b = b.zData, b.length && (B = r(c.zMin, Math.min(B, Math.max(F(b), !1 === c.displayNegative ?
                    c.zThreshold : -Number.MAX_VALUE))), k = r(c.zMax, Math.max(k, z(b))))))
            });
            f(J, function (b) {
                var d = b[n], f = d.length, m;
                g && b.getRadii(B, k, b.minPxSize, b.maxPxSize);
                if (0 < D)for (; f--;)h(d[f]) && a.dataMin <= d[f] && d[f] <= a.dataMax && (m = b.radii[f], e = Math.min((d[f] - q) * I - m, e), c = Math.max((d[f] - q) * I + m, c))
            });
            J.length && 0 < D && !this.isLog && (c -= b, I *= (b + e - c) / b, f([["min", "userMin", e], ["max", "userMax", c]], function (b) {
                void 0 === r(a.options[b[0]], a[b[1]]) && (a[b[0]] += b[2] / I)
            }))
        }
    })(J);
    (function (a) {
        var z = a.merge, F = a.Point, D = a.seriesType,
            B = a.seriesTypes;
        B.bubble && D("mapbubble", "bubble", {
            ...
            applyOptions: function (a, h) {
                return a && void 0 !== a.lat && void 0 !== a.lon ? F.prototype.applyOptions.call(this, z(a, this.series.chart.fromLatLonToPoint(a)), h) : B.map.prototype.pointClass.prototype.applyOptions.call(this, a, h)
            }, ttBelow: !1
        })
    })(J);
    (function (a) {
        var z = a.colorPointMixin, F = a.each, D = a.merge, B = a.noop, f = a.pick, h = a.Series, t = a.seriesType, r = a.seriesTypes;
        t("heatmap", "scatter", {
            animation: !1,
            borderWidth: 0,
            nullColor: "#f7f7f7",
            ...
            translate: function () {
                var a = this.options, d = this.xAxis, f = this.yAxis, h = function (a, d, b) {
                    return Math.min(Math.max(d, a), b)
                };
                this.generatePoints();
                F(this.points, function (g) {
                    var m = (a.colsize || 1) / 2, b = (a.rowsize || 1) / 2, l = h(Math.round(d.len - d.translate(g.x -
                            m, 0, 1, 0, 1)), -d.len, 2 * d.len), m = h(Math.round(d.len - d.translate(g.x + m, 0, 1, 0, 1)), -d.len, 2 * d.len), e = h(Math.round(f.translate(g.y - b, 0, 1, 0, 1)), -f.len, 2 * f.len), b = h(Math.round(f.translate(g.y + b, 0, 1, 0, 1)), -f.len, 2 * f.len);
    ...
    (function (a) {
        function z(a, d) {
            var f, h, m, r = !1, b = a.x, l = a.y;
            a = 0;
            for (f = d.length - 1; a < d.length; f = a++)h = d[a][1] > l, m = d[f][1] > l, h !== m && b < (d[f][0] - d[a][0]) * (l - d[a][1]) / (d[f][1] - d[a][1]) + d[a][0] && (r = !r);
            return r
        }

        var F =
            a.Chart, D = a.each, B = a.extend, f = a.format, h = a.merge, t = a.win, r = a.wrap;
        F.prototype.transformFromLatLon = function (f, d) {
            if (void 0 === t.proj4)return a.error(21), {x: 0, y: null};
            f = t.proj4(d.crs, [f.lon, f.lat]);
            var g = d.cosAngle || d.rotation && Math.cos(d.rotation), h = d.sinAngle || d.rotation && Math.sin(d.rotation);
        ...
        F.prototype.transformToLatLon = function (f, d) {
            if (void 0 === t.proj4) a.error(21); else {
                f = {
                    x: ((f.x - (d.jsonmarginX || 0)) / (d.jsonres || 1) - (d.xpan || 0)) / (d.scale || 1) + (d.xoffset || 0),
                    y: ((-f.y - (d.jsonmarginY || 0)) / (d.jsonres || 1) + (d.ypan || 0)) / (d.scale || 1) + (d.yoffset || 0)
                };
                var g = d.cosAngle || d.rotation && Math.cos(d.rotation), h = d.sinAngle || d.rotation && Math.sin(d.rotation);
                d = t.proj4(d.crs, "WGS84", d.rotation ? {x: f.x * g + f.y * -h, y: f.x * h + f.y * g} : f);
        ...
        F.prototype.fromLatLonToPoint = function (f) {
            var d = this.mapTransforms, g, h;
            if (!d)return a.error(22), {x: 0, y: null};
        ...
        a.geojson =
            function (a, d, g) {
                ...
                D(a.features, function (a) {
                    var b = a.geometry, e = b.type, b = b.coordinates;
                    a = a.properties;
                    var c;
                    m = [];
                    "map" === d || "mapbubble" === d ? ("Polygon" === e ? (D(b, r), m.push("Z")) : "MultiPolygon" === e && (D(b, function (a) {
                                D(a, r)
                            }), m.push("Z")), m.length && (c = {path: m})) : "mapline" === d ? ("LineString" === e ? r(b) : "MultiLineString" === e && D(b, r), m.length && (c = {path: m})) : "mappoint" === d && "Point" ===
                            e && (c = {x: b[0], y: -b[1]});
                    c && h.push(B(c, {name: a.name || a.NAME, properties: a}))
                });
                g && a.copyrightShort && (g.chart.mapCredits = f(g.chart.options.credits.mapText, {geojson: a}), g.chart.mapCreditsFull = f(g.chart.options.credits.mapTextFull, {geojson: a}));
                return h
            };
    ...
    (function (a) {
        function z(a, d, f, h, b, l, e, c) {
            return ["M",
                a + b, d, "L", a + f - l, d, "C", a + f - l / 2, d, a + f, d + l / 2, a + f, d + l, "L", a + f, d + h - e, "C", a + f, d + h - e / 2, a + f - e / 2, d + h, a + f - e, d + h, "L", a + c, d + h, "C", a + c / 2, d + h, a, d + h - c / 2, a, d + h - c, "L", a, d + b, "C", a, d + b / 2, a + b / 2, d, a + b, d, "Z"]
        }

        var F = a.Chart, D = a.defaultOptions, B = a.each, f = a.extend, h = a.merge, t = a.pick, r = a.Renderer, m = a.SVGRenderer, d = a.VMLRenderer;
        f(D.lang, {zoomIn: "Zoom in", zoomOut: "Zoom out"});
        D.mapNavigation = {
            buttonOptions: {
                alignTo: "plotBox",
                align: "left",
        ...
        a.Map = a.mapChart = function (d, f, m) {
            var g = "string" === typeof d || d.nodeName, b = arguments[g ? 1 : 0], l = {
                endOnTick: !1,
                visible: !1,
                minPadding: 0,
                maxPadding: 0,
            ...
            b = h({
                ...
                }, tooltip: {followTouchMove: !1}, xAxis: l, yAxis: h(l, {reversed: !0})
            }, b, {chart: {inverted: !1, alignTicks: !1}});
            b.series = e;
